...
Section "fReeverb VST-Plugin" SecProgramFiles
  SetOutPath "$INSTDIR"
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\UninstallfReeverb.exe"
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecProgramFiles ${LANG_ENGLISH} "fReeverb VST Plugin"
