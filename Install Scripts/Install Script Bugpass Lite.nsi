...
Section "Bugpass Lite VST-Plugin" SecProgramFiles
  SetOutPath "$INSTDIR"
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\UninstallBugpassLite.exe"
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecProgramFiles ${LANG_ENGLISH} "Bugpass Lite VST Plugin"
