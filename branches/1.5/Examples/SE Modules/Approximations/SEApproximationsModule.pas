...
procedure TSEApproximationsModule.SubProcessStatic(const BufferOffset,
...
function TSEFastSineApproximationsSingleModule.GetPinProperties
...
procedure TSEFastSineApproximationsSingleModule.PlugStateChange
...
begin
  ...
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FFloatOut := FastSin3Term(FFloatIn);
      4:
        FFloatOut := FastSin4Term(FFloatIn);
      5:
        FFloatOut := FastSin5Term(FFloatIn);
      6:
        FFloatOut := FastSin6Term(FFloatIn);
      7:
        FFloatOut := FastSin7Term(FFloatIn);
    end;
end;
...
function TSEFastSineApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastSineApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FDoubleOut := FastSin3Term(FDoubleIn);
      4:
        FDoubleOut := FastSin4Term(FDoubleIn);
      5:
        FDoubleOut := FastSin5Term(FDoubleIn);
      6:
        FDoubleOut := FastSin6Term(FDoubleIn);
      7:
        FDoubleOut := FastSin7Term(FDoubleIn);
    end;
end;
...
function TSEFastCosineApproximationsSingleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastCosineApproximationsSingleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FFloatOut := FastCos3Term(FFloatIn);
      4:
        FFloatOut := FastCos4Term(FFloatIn);
      5:
        FFloatOut := FastCos5Term(FFloatIn);
      6:
        FFloatOut := FastCos6Term(FFloatIn);
      7:
        FFloatOut := FastCos7Term(FFloatIn);
    end;
end;
...
function TSEFastCosineApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastCosineApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FDoubleOut := FastCos3Term(FDoubleIn);
      4:
        FDoubleOut := FastCos4Term(FDoubleIn);
      5:
        FDoubleOut := FastCos5Term(FDoubleIn);
      6:
        FDoubleOut := FastCos6Term(FDoubleIn);
      7:
        FDoubleOut := FastCos7Term(FDoubleIn);
    end;
end;
...
function TSEFastTangensApproximationsSingleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastTangensApproximationsSingleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FFloatOut := FastTan2Term(FFloatIn);
      3:
        FFloatOut := FastTan3Term(FFloatIn);
      4:
        FFloatOut := FastTan4Term(FFloatIn);
      6:
        FFloatOut := FastTan6Term(FFloatIn);
    end;
end;
...
function TSEFastTangensApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastTangensApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FDoubleOut := FastTan2Term(FDoubleIn);
      3:
        FDoubleOut := FastTan3Term(FDoubleIn);
      4:
        FDoubleOut := FastTan4Term(FDoubleIn);
      6:
        FDoubleOut := FastTan6Term(FDoubleIn);
    end;
end;
...
function TSEFastCotangensApproximationsSingleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastCotangensApproximationsSingleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FFloatOut := FastCotan2Term(FFloatIn);
      3:
        FFloatOut := FastCotan3Term(FFloatIn);
      4:
        FFloatOut := FastCotan4Term(FFloatIn);
      6:
        FFloatOut := FastCotan6Term(FFloatIn);
    end;
end;
...
function TSEFastCotangensApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastCotangensApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FDoubleOut := FastCotan2Term(FDoubleIn);
      3:
        FDoubleOut := FastCotan3Term(FDoubleIn);
      4:
        FDoubleOut := FastCotan4Term(FDoubleIn);
      6:
        FDoubleOut := FastCotan6Term(FDoubleIn);
    end;
end;
...
function TSEFastArcTanApproximationsSingleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastArcTanApproximationsSingleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FFloatOut := FastArcTan3Term(FFloatIn);
      6:
        FFloatOut := FastArcTan6Term(FFloatIn);
    end;
end;
...
function TSEFastArcTanApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastArcTanApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FDoubleOut := FastArcTan3Term(FDoubleIn);
      6:
        FDoubleOut := FastArcTan6Term(FDoubleIn);
    end;
end;
...
function TSEFastArcCotanApproximationsSingleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastArcCotanApproximationsSingleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FFloatOut := FastArcCotan3Term(FFloatIn);
      6:
        FFloatOut := FastArcCotan6Term(FFloatIn);
    end;
end;
...
function TSEFastArcCotanApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastArcCotanApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      3:
        FDoubleOut := FastArcCotan3Term(FDoubleIn);
      6:
        FDoubleOut := FastArcCotan6Term(FDoubleIn);
    end;
end;
...
function TSEFastLog2ApproximationsSingleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastLog2ApproximationsSingleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FFloatOut := FastLog2MinError2(FFloatIn);
      3:
        FFloatOut := FastLog2MinError3(FFloatIn);
      4:
        FFloatOut := FastLog2MinError4(FFloatIn);
      5:
        FFloatOut := FastLog2MinError5(FFloatIn);
    end;
end;
...
function TSEFastLog2ApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastLog2ApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FDoubleOut := FastLog2MinError2(FDoubleIn);
      3:
        FDoubleOut := FastLog2MinError3(FDoubleIn);
      4:
        FDoubleOut := FastLog2MinError4(FDoubleIn);
      5:
        FDoubleOut := FastLog2MinError5(FDoubleIn);
    end;
end;
...
function TSEFastPower2ApproximationsSingleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastPower2ApproximationsSingleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FFloatOut := FastPower2MinError2(FFloatIn);
      3:
        FFloatOut := FastPower2MinError3(FFloatIn);
      4:
        FFloatOut := FastPower2MinError4(FFloatIn);
      5:
        FFloatOut := FastPower2MinError5(FFloatIn);
    end;
end;
...
function TSEFastPower2ApproximationsDoubleModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
procedure TSEFastPower2ApproximationsDoubleModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  if CurrentPin.PinID = 0 then
    case FTerms of
      2:
        FDoubleOut := FastPower2MinError2(FDoubleIn);
      3:
        FDoubleOut := FastPower2MinError3(FDoubleIn);
      4:
        FDoubleOut := FastPower2MinError4(FDoubleIn);
      5:
        FDoubleOut := FastPower2MinError5(FDoubleIn);
    end;
end;
