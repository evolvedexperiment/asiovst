...
Section "SubBoost VST-Plugin" SecProgramFiles
  SetOutPath "$INSTDIR"
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\UninstallSubBoost.exe"
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecProgramFiles ${LANG_ENGLISH} "SubBoost VST Plugin"
