...
type
  ...
  protected
    ...
    property Items[Index: Integer]: TGuiStitchedImageCollectionItem
      read GetStitchedItems; default;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  published
    property StitchedImages: TGuiStitchedImageCollection
      read FStitchedCollection write FStitchedCollection;
  end;
