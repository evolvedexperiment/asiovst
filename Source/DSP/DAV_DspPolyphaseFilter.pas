...
type
  ...
  public
    ...
    procedure SetCoefficients(const Coefficients: TDAVDoubleDynArray);
      overload; virtual;
    procedure SetCoefficients(const NumberOfCoefficients: Integer = 8;
      const Transition: Double = 0.1); overload; virtual;

    property NumberOfCoefficients: Integer read FNumberOfCoeffs
      write SetNumberOfCoeffs;
...
procedure TCustomPolyphaseFilter.SetCoefficients(const Coefficients
  : TDAVDoubleDynArray);
begin
...
procedure TCustomPolyphaseFilter.SetCoefficients(const NumberOfCoefficients
  : Integer = 8; const Transition: Double = 0.1);
var
  tmpCoeffs: TDAVDoubleDynArray;
begin
  SetLength(tmpCoeffs, NumberOfCoefficients);
  TPolyphaseIirDesigner.ComputeCoeffsSpecOrderTBW(tmpCoeffs,
    NumberOfCoefficients, Transition);
  FAttenuation := TPolyphaseIirDesigner.ComputeAttenuationFromOrderTBW
    (FNumberOfCoeffs, FTransition);
