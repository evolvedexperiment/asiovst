...
function GetInputConverter32(ConverterType: TAsioSampleType)
  : TBlockConvertToFloat32;
begin
  case ConverterType of
    CAsioSTInt16MSB:
      Result := BlockConvertInt16MSBToFloat32;
    CAsioSTInt24MSB:
      Result := BlockConvertInt24MSBToFloat32;
    CAsioSTInt32MSB:
      Result := BlockConvertInt32MSBToFloat32;
    // CAsioSTFloat32MSB : Result := FromSingleMSB;
    // CAsioSTFloat64MSB : Result := FromDoubleMSB;
    CAsioSTInt32MSB16:
      Result := BlockConvertInt32MSB16ToFloat32;
    CAsioSTInt32MSB18:
      Result := BlockConvertInt32MSB18ToFloat32;
    CAsioSTInt32MSB20:
      Result := BlockConvertInt32MSB20ToFloat32;
    CAsioSTInt32MSB24:
      Result := BlockConvertInt32MSB24ToFloat32;
    CAsioSTInt16LSB:
      Result := BlockConvertInt16LSBToFloat32;
    CAsioSTInt24LSB:
      Result := BlockConvertInt24LSBToFloat32;
    CAsioSTInt32LSB:
      Result := BlockConvertInt32LSBToFloat32;
    // CAsioSTFloat32LSB : Result := FromSingleLSB;
    // CAsioSTFloat64LSB : Result := FromDoubleLSB;
    CAsioSTInt32LSB16:
      Result := BlockConvertInt32LSB16ToFloat32;
    CAsioSTInt32LSB18:
      Result := BlockConvertInt32LSB18ToFloat32;
    CAsioSTInt32LSB20:
      Result := BlockConvertInt32LSB20ToFloat32;
    CAsioSTInt32LSB24:
      Result := BlockConvertInt32LSB24ToFloat32;
    // else raise EAsioHost.Create(RStrConverterTypeUnknown);
  end;
end;

function GetOutputConverter32(ConverterType: TAsioSampleType)
  : TBlockConvertFromFloat32;
begin
  case ConverterType of
    CAsioSTInt16MSB:
      Result := BlockConvertInt16MSBFromFloat32;
    CAsioSTInt24MSB:
      Result := BlockConvertInt24MSBFromFloat32;
    CAsioSTInt32MSB:
      Result := BlockConvertInt32MSBFromFloat32;
    // CAsioSTFloat32MSB : Result := FromSingleMSB;
    // CAsioSTFloat64MSB : Result := FromDoubleMSB;
    CAsioSTInt32MSB16:
      Result := BlockConvertInt32MSB16FromFloat32;
    CAsioSTInt32MSB18:
      Result := BlockConvertInt32MSB18FromFloat32;
    CAsioSTInt32MSB20:
      Result := BlockConvertInt32MSB20FromFloat32;
    CAsioSTInt32MSB24:
      Result := BlockConvertInt32MSB24FromFloat32;
    CAsioSTInt16LSB:
      Result := BlockConvertInt16LSBFromFloat32;
    CAsioSTInt24LSB:
      Result := BlockConvertInt24LSBFromFloat32;
    CAsioSTInt32LSB:
      Result := BlockConvertInt32LSBFromFloat32;
    // CAsioSTFloat32LSB : Result := FromSingleLSB;
    // CAsioSTFloat64LSB : Result := FromDoubleLSB;
    CAsioSTInt32LSB16:
      Result := BlockConvertInt32LSB16FromFloat32;
    CAsioSTInt32LSB18:
      Result := BlockConvertInt32LSB18FromFloat32;
    CAsioSTInt32LSB20:
      Result := BlockConvertInt32LSB20FromFloat32;
    CAsioSTInt32LSB24:
      Result := BlockConvertInt32LSB24FromFloat32;
    // else raise EAsioHost.Create(RStrConverterTypeUnknown);
  end;
end;
