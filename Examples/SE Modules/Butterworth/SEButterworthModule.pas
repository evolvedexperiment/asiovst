...
type
  ...
  protected
    ...
    class function GetFilterClass: TCustomButterworthFilterClass;
      virtual; abstract;
  public
...
procedure TSEButterworthModule.SubProcess(const BufferOffset,
...
procedure TSEButterworthModule.SubProcessStatic(const BufferOffset,
  SampleFrames: Integer);
begin
...
class procedure TSEButterworthModule.GetModuleProperties
...
function TSEButterworthModule.GetPinProperties(const Index: Integer;
...
class procedure TSEStaticButterworthLPModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
...
function TSEStaticButterworthLPModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
...
begin
  ...
  case TSEButterworthPins(CurrentPin.PinID) of
    ...
    pinFrequency:
      FFilter.Frequency := 1E-5 + abs(FFrequency);
    pinOrder:
      FFilter.Order := FOrder;
  end;
  inherited;
...
class procedure TSEStaticButterworthHPModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
function TSEStaticButterworthHPModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case TSEButterworthPins(index) of
...
begin
  ...
  if Index in [2 .. 3] then
    Properties^.Direction := drIn;
end;

class procedure TSEControlableButterworthLPModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSEControlableButterworthHPModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
function TSEAutomatableButterworthLPModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case TSEButterworthPins(Index) of
...
function TSEAutomatableButterworthHPModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case TSEButterworthPins(Index) of
...
function TSEAutomatableXButterworthLPModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case TSEButterworthPins(Index) of
...
function TSEAutomatableXButterworthHPModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case TSEButterworthPins(Index) of
