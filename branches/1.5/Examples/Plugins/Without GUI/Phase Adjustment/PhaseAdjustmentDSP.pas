...
type
  ...
  public
    property SuppressHighFrequencyRinging: Boolean read FSuppressRinging
      write SetSuppressRinging default True;
...
uses
  Math, DAV_Math, DAV_StringConvert, DAV_DspWindowing;
