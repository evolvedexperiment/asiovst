...
type
  ...
  public
    ...
    class procedure GetModuleProperties(
      Properties: PSEModuleProperties); override;
  ...
  TSEDitherNoiseshaperControllableModule = class
...
constructor TCustomSEDitherNoiseshaperModule.Create(
...
procedure TCustomSEDitherNoiseshaperModule.SubProcessStatic(const BufferOffset,
...
class procedure TCustomSEDitherNoiseshaperModule.GetModuleProperties
...
function TCustomSEDitherNoiseshaperModule.GetPinProperties(const Index: Integer;
...
procedure TCustomSEDitherNoiseshaperModule.PlugStateChange
...
procedure TSEDitherNoiseshaperStaticModule.SubProcess(const BufferOffset,
  SampleFrames: Integer);
var
...
// describe the pins (plugs)
function TSEDitherNoiseshaperStaticModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
...
// An input plug has changed value
procedure TSEDitherNoiseshaperStaticModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  case TSEDitherNoiseshaperPins(CurrentPin.PinID) of
    ...
    pinNoiseshaperType:
      FDitherNoiseshaper.NoiseshaperType := FNoiseshaperType;
  end;
end;
...
function TSEDitherNoiseshaperControllableModule.GetPinProperties
