...
procedure FadeExponential_FPU(Data: PSingle; SampleCount: Integer;
  ScaleFactor, Gradient: Single); overload;
{ -$IFDEF PUREPASCAL }
var
  SampleIndex: Integer;
begin
...
procedure FadeExponential_FPU(Data: PDouble; SampleCount: Integer;
  ScaleFactor, Gradient: Double); overload;
{ -$IFDEF PUREPASCAL }
var
  SampleIndex: Integer;
begin
...
procedure FadeLinear_FPU(Data: PSingle; SampleCount: Integer;
  ScaleFactor, Gradient: Single); overload;
{$IFDEF PUREPASCAL}
var
  SampleIndex: Integer;
...
procedure FadeLinear_FPU(Data: PDouble; SampleCount: Integer;
  ScaleFactor, Gradient: Double); overload;
{$IFDEF PUREPASCAL}
var
  SampleIndex: Integer;
...
begin
  ...
  begin
    b := BufArray[0];
    BufArray[0] := BufArray[3];
    BufArray[3] := b;
    b := BufArray[1];
    BufArray[1] := BufArray[2];
    BufArray[2] := b;
    Inc(BufByte, 4);
  end;
end;
...
begin
  ...
  begin
    b := BufArray[0];
    BufArray[0] := BufArray[7];
    BufArray[7] := b;
    b := BufArray[1];
    BufArray[1] := BufArray[6];
    BufArray[6] := b;
    b := BufArray[2];
    BufArray[2] := BufArray[5];
    BufArray[5] := b;
    b := BufArray[3];
    BufArray[3] := BufArray[4];
    BufArray[4] := b;
    Inc(BufByte, 8);
  end;
{$ELSE}
...
procedure Int16LSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
{$IFDEF PUREPASCAL}
var
...
procedure Int16LSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt);
{$IFDEF PUREPASCAL}
var
...
begin
  for SampleIndex := 0 to SampleCount - 1 do
    TargetArray[SampleIndex] := SourceArray[SampleIndex] * CSmallToFloat;
end;
{$ELSE}
asm
  FLD   CSmallToFloat        // for speed
...
procedure Int24LSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
{$IFDEF PUREPASCAL}
var
...
procedure Int24LSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceInt: PInteger absolute Source;
  SourceByte: PByte absolute Source;
...
procedure Int32LSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
...
begin
  for SampleIndex := 0 to SampleCount - 1 do
    TargetArray[SampleIndex] := SourceArray[SampleIndex] * CIntToFloat;
end;
{$ELSE}
asm
...
procedure Int32LSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
...
procedure SingleLSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
begin
  Move(Source^, Target^, SampleCount * SizeOf(Single));
end;

procedure SingleLSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
...
begin
  for SampleIndex := 0 to SampleCount - 1 do
    TargetArray[SampleIndex] := SourceArray[SampleIndex];
end;
{$ELSE}
asm
@Start:
...
procedure DoubleLSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
...
procedure DoubleLSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
begin
  Move(Source^, Target^, SampleCount * SizeOf(Double));
end;

procedure Int32LSB16ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload; // 32 bit data with 16 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
  TargetArray: PDAVSingleFixedArray absolute Target;
...
begin
  for i := 0 to SampleCount - 1 do
    TargetArray[i] := SourceArray[i] * CSmallToFloat;
end;
{$ELSE}
asm
  FLD      CSmallToFloat
...
procedure Int32LSB16ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload; // 32 bit data with 16 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
...
procedure Int32LSB18ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload; // 32 bit data with 18 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
  TargetArray: PDAVSingleFixedArray absolute Target;
...
begin
  for i := 0 to SampleCount - 1 do
    TargetArray[i] := SourceArray[i] * CInt18ToFloat;
end;
{$ELSE}
asm
  FLD      CInt18ToFloat
...
procedure Int32LSB18ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload; // 32 bit data with 18 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
...
procedure Int32LSB20ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload; // 32 bit data with 20 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
  TargetArray: PDAVSingleFixedArray absolute Target;
...
begin
  for i := 0 to SampleCount - 1 do
    TargetArray[i] := SourceArray[i] * CInt20ToFloat;
end;
{$ELSE}
asm
  FLD      CInt20ToFloat
...
procedure Int32LSB20ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload; // 32 bit data with 20 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
...
procedure Int32LSB24ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload; // 32 bit data with 24 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
  TargetArray: PDAVSingleFixedArray absolute Target;
...
begin
  for i := 0 to SampleCount - 1 do
    TargetArray[i] := SourceArray[i] * CInt24ToFloat;
end;
{$ELSE}
asm
  FLD      CInt24ToFloat
...
procedure Int32LSB24ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload; // 32 bit data with 24 bit alignment
{$IFDEF PUREPASCAL}
var
  SourceArray: PntgrArray absolute Source;
...
procedure Int16MSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PWrdArray absolute Source;
...
procedure Int16MSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PWrdArray absolute Source;
...
procedure Int24MSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure Int24MSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian3(Source, SampleCount);
...
procedure Int32MSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure Int32MSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure SingleMSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  Move(Source^, Target^, SampleCount * SizeOf(Single));
...
procedure SingleMSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure DoubleMSBToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
begin
...
procedure DoubleMSBToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
begin
  Move(Source^, Target^, SampleCount * SizeOf(Double));
...
procedure Int32MSB16ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure Int32MSB16ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure Int32MSB18ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure Int32MSB18ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure Int32MSB20ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure Int32MSB20ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure Int32MSB24ToSingle_FPU(Source: Pointer; Target: PSingle;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure Int32MSB24ToDouble_FPU(Source: Pointer; Target: PDouble;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  ReverseEndian4(Source, SampleCount);
...
procedure SingleToInt16LSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVSingleFixedArray absolute Source;
...
procedure SingleToInt16LSB_UDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
...
procedure SingleToInt16LSB_TDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
...
procedure DoubleToInt16LSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVDoubleFixedArray absolute Source;
...
procedure DoubleToInt16LSB_UDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt16LSB_TDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt24LSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVSingleFixedArray absolute Source;
...
procedure SingleToInt24LSB_UDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
...
procedure SingleToInt24LSB_TDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt24LSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVDoubleFixedArray absolute Source;
...
procedure DoubleToInt24LSB_UDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt24LSB_TDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVSingleFixedArray absolute Source;
...
procedure DoubleToInt32LSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVDoubleFixedArray absolute Source;
...
procedure SingleToSingleLSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
begin
  Move(Source^, Target^, SampleCount * SizeOf(Single));
end;

procedure DoubleToSingleLSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SampleIndex: Integer;
...
procedure SingleToDoubleLSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SampleIndex: Integer;
...
procedure DoubleToDoubleLSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
begin
  Move(Source^, Target^, SampleCount * SizeOf(Double));
end;

procedure SingleToInt32LSB16_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVSingleFixedArray absolute Source;
...
procedure SingleToInt32LSB16_UDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB16_TDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB16_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVDoubleFixedArray absolute Source;
...
procedure DoubleToInt32LSB16_UDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB16_TDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB18_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVSingleFixedArray absolute Source;
...
procedure SingleToInt32LSB18_UDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB18_TDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB18_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVDoubleFixedArray absolute Source;
...
procedure DoubleToInt32LSB18_UDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB18_TDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB20_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVSingleFixedArray absolute Source;
...
procedure SingleToInt32LSB20_UDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB20_TDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB20_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVDoubleFixedArray absolute Source;
...
procedure DoubleToInt32LSB20_UDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB20_TDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB24_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVSingleFixedArray absolute Source;
...
procedure SingleToInt32LSB24_UDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt32LSB24_TDF_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB24_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
var
  SourceArray: PDAVDoubleFixedArray absolute Source;
...
procedure DoubleToInt32LSB24_UDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((1.0 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure DoubleToInt32LSB24_TDF_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
const
  CScaler: Double = ((0.5 / $10000) / $10000); // 2^-32
{$IFDEF PUREPASCAL}
...
procedure SingleToInt16MSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure DoubleToInt16MSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure SingleToInt24MSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
begin
...
procedure DoubleToInt24MSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
begin
...
procedure SingleToInt32MSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure DoubleToInt32MSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure SingleToSingleMSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
begin
  Move(Source^, Target^, SampleCount * SizeOf(Single));
  ReverseEndian4(Target, SampleCount);
...
procedure DoubleToSingleMSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
  DoubleLSBToSingle_FPU(Source, Target, SampleCount);
...
procedure SingleToDoubleMSB_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
begin
...
procedure DoubleToDoubleMSB_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
begin
  Move(Source^, Target^, SampleCount * SizeOf(Double));
  ReverseEndian8(Target, SampleCount);
...
procedure SingleToInt32MSB16_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure DoubleToInt32MSB16_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure SingleToInt32MSB18_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure DoubleToInt32MSB18_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure SingleToInt32MSB20_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure DoubleToInt32MSB20_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure SingleToInt32MSB24_FPU(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
procedure DoubleToInt32MSB24_FPU(Source: PDouble; Target: Pointer;
  SampleCount: LongInt); overload;
{$IFDEF PUREPASCAL}
begin
...
function ClipCheckInt32LSB16_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
...
function ClipCheckInt32LSB18_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
  IntCast: PInteger absolute Source;
...
function ClipCheckInt32LSB20_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
  IntCast: PInteger absolute Source;
...
function ClipCheckInt32LSB24_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
  IntCast: PInteger absolute Source;
...
function ClipCheckInt32MSB16_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
  IntCast: PInteger absolute Source;
...
function ClipCheckInt32MSB18_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
  IntCast: PInteger absolute Source;
...
function ClipCheckInt32MSB20_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
  IntCast: PInteger absolute Source;
...
function ClipCheckInt32MSB24_FPU(Source: Pointer; SampleCount: LongInt)
  : Boolean;
var
  SampleIndex: Integer;
  IntCast: PInteger absolute Source;
...
procedure MixBuffers_FPU(Data: PSingle; MixBuffer: PSingle;
...
procedure MixBuffers_FPU(Data: PDouble; MixBuffer: PDouble;
  SampleCount: Integer); overload;
{$IFDEF PUREPASCAL}
var
  SampleIndex: Integer;
...
procedure Volume_FPU(Data: PSingle; Volume: Single;
  SampleCount: Integer); overload;
{$IFDEF PUREPASCAL}
var
  SampleIndex: Integer;
...
procedure Volume_FPU(Data: PDouble; Volume: Double;
  SampleCount: Integer); overload;
{$IFDEF PUREPASCAL}
var
  SampleIndex: Integer;
...
const
  c3: Single = 3;
  c6: Single = 6;
  mm1sgn: array [0 .. 3] of Integer = ($7FFFFFFF, $7FFFFFFF, $7FFFFFFF,
    $7FFFFFFF);
...
procedure SingleToSingle_SSE(Source: PSingle; Target: Pointer;
  SampleCount: LongInt); // IEEE 754 32 bit float
asm
  PUSH ECX
...
procedure SingleToInt32LSB_SSE(Source: PSingle; Target: Pointer;
  SampleCount: LongInt);
asm
...
procedure MixBuffers_SSE(Data: PSingle; MixBuffer: PSingle;
  SampleCount: Integer);
asm
  PUSH ECX
  SHR ECX, 4  // number of large iterations = number of elements / 16
...
procedure SingleToInt16LSB_3DNow(Source: PSingle; Target: Pointer;
  SampleCount: LongInt);
var
...
procedure SingleToInt32LSB_3DNow(Source: PSingle; Target: Pointer;
  SampleCount: LongInt);
asm
  FEMMS                     // Fast MMX Enter/Leave
  SHR       ECX, 3          // Unroll the LOOP by 8
...
procedure SingleToInt32LSB16_3DNow(Source: PSingle; Target: Pointer;
  SampleCount: LongInt);
asm
  FEMMS                     // Fast MMX Enter/Leave
  SHR       ECX, 3          // Unroll the LOOP by 8
...
procedure SingleToInt32LSB18_3DNow(Source: PSingle; Target: Pointer;
  SampleCount: LongInt);
asm
  FEMMS                     // Fast MMX Enter/Leave
  SHR       ECX, 3          // Unroll the LOOP by 8
...
procedure SingleToInt32LSB20_3DNow(Source: PSingle; Target: Pointer;
  SampleCount: LongInt);
asm
  FEMMS                     // Fast MMX Enter/Leave
  SHR       ECX, 3          // Unroll the LOOP by 8
...
procedure SingleToInt32LSB24_3DNow(Source: PSingle; Target: Pointer;
  SampleCount: LongInt);
asm
  FEMMS                     // Fast MMX Enter/Leave
  SHR       ECX, 3          // Unroll the LOOP by 8
...
procedure ToInt16LSB_3DNow(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
asm
  FEMMS                    // Fast MMX Enter/Leave
  SHR       ECX, 3         // unroll the LOOP by 8
...
procedure Int32LSBToSingle_3DNow(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
asm
  FEMMS                    // Fast MMX Enter/Leave
  SHR       ECX, 3         // unroll the LOOP by 8
...
procedure Int32LSB16ToSingle_3DNow(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
asm
  FEMMS                    // Fast MMX Enter/Leave
  SHR       ECX, 3         // unroll the LOOP by 8
...
procedure Int32LSB18ToSingle_3DNow(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
asm
  FEMMS                    // Fast MMX Enter/Leave
  SHR       ECX, 3         // unroll the LOOP by 8
...
procedure Int32LSB20ToSingle_3DNow(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
asm
  FEMMS                    // Fast MMX Enter/Leave
  SHR       ECX, 3         // unroll the LOOP by 8
...
procedure Int32LSB24ToSingle_3DNow(Source: Pointer; Target: PSingle;
  SampleCount: LongInt);
asm
  FEMMS                    // Fast MMX Enter/Leave
  SHR       ECX, 3         // unroll the LOOP by 8
...
procedure MixBuffers_3DNow(Data: PSingle; MixBuffer: PSingle;
  SampleCount: Integer);
asm
  FEMMS
  SHR       ECX, 3
