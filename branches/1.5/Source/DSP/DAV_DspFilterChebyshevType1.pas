...
type
  ...
  public
    ...
    procedure SetFilterValues(const AFrequency, AGain,
      ARipple: Single); virtual;
...
procedure TCustomChebyshev1Filter.SetFilterValues(const AFrequency, AGain,
  ARipple: Single);
begin
...
function TCustomChebyshev1Filter.MagnitudeLog10(const Frequency
  : Double): Double;
begin
...
function TChebyshev1LowpassFilter.MagnitudeSquared(const Frequency
  : Double): Double;
var
  i: Integer;
  A, cw: Double;
...
begin
  ...
  begin
    ComplexMultiplyInplace64(Den, Nom,
      (Cmplx.Re * (FCoeffs[2 * i + 1] - FCoeffs[2 * i] - 1 + Cmplx.Re *
      (1 - FCoeffs[2 * i + 1])) + FCoeffs[2 * i]),
...
function TChebyshev1LowpassFilterAutomatable.MagnitudeLog10(const Frequency
  : Double): Double;
const
...
function TChebyshev1LowpassFilterAutomatable.MagnitudeSquared(const Frequency
  : Double): Double;
var
  i: Integer;
  A, cw: Double;
...
function TChebyshev1HighpassFilter.MagnitudeSquared(const Frequency
  : Double): Double;
var
  i: Integer;
  A, cw: Double;
...
function TChebyshev1HighpassFilterAutomatable.MagnitudeLog10(const Frequency
  : Double): Double;
const
  CLogScale: Double = 3.0102999566398119521373889472449;
begin
...
function TChebyshev1HighpassFilterAutomatable.MagnitudeSquared(const Frequency
  : Double): Double;
var
  i: Integer;
  A, cw: Double;
...
RegisterDspProcessors64([TChebyshev1LowpassFilter, TChebyshev1HighpassFilter,
  TChebyshev1LowpassFilterAutomatable, TChebyshev1HighpassFilterAutomatable]);
