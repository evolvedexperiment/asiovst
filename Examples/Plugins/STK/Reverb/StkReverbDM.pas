...
procedure TStkReverbModule.VSTModuleEditOpen(Sender: TObject; var GUI: TForm;
  ParentWindow: NativeUInt);
begin
...
procedure TStkReverbModule.ParamT60Change(Sender: TObject; const Index: Integer;
  var Value: Single);
begin
  while FSemaphore > 0 do
    Sleep(1);
...
procedure TStkReverbModule.ParamAlgorithmDisplay(Sender: TObject;
  const Index: Integer; var PreDefined: AnsiString);
begin
  case Round(Parameter[Index]) of
    0:
      PreDefined := 'modified STK "NRev"';
    1:
      PreDefined := 'modified STK "JCRev"';
    2:
      PreDefined := 'modified STK "PRCRev"';
    3:
      PreDefined := 'STK "NRev" & "JCRev" blend';
    4:
      PreDefined := 'STK "PRCRev" & "JCRev" blend';
  end;
end;

procedure TStkReverbModule.ParamAlgorithmChange(Sender: TObject;
