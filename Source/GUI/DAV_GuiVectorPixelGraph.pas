  ...
  if Assigned(GeometricShape.OnGetValue) then
    ...
    begin
      ...
      for PtIndex := 0 to Length(YValues) - 1 do
        YValues[PtIndex].Fixed := GeometricShape.OnGetValue(Self,
          PtIndex - IntegerRadiusX).Fixed;

      for x := GeometricShape.MarginLeft to Width -
        GeometricShape.MarginRight - 1 do
      begin
        // get next value
        YValues[Length(YValues) - 1].Fixed := GeometricShape.OnGetValue(Self,
          x + IntegerRadiusX).Fixed;
