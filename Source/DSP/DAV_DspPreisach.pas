...
type
  ...
  public
    ...
    property HysteronResolution: Integer read FHysteronResolution
      write SetHysteronResolution;
  end;
...
begin
  FTotalHysteronCount :=
    ((FHysteronResolution - 1) * FHysteronResolution) div 2;
...
begin
  ...
  else if X < FHysteronResolution - 1 then
  begin
...
begin
  ...
  begin
    ...
    IntegerResult := 0;
    for HysteronIndex := 0 to Offset - 1 do
      Inc(IntegerResult, FStates[HysteronIndex]);
    Inc(IntegerResult, FTotalHysteronCount - Offset);
  end;
  Result := 2 * FHysteronScale * IntegerResult - 1;
end;
