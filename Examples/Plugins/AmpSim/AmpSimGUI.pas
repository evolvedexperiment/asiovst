...
begin
  ...
  begin
    if Parameter[0] <> SBModel.ItemIndex then
      Parameter[0] := SBModel.ItemIndex;
  end;
end;
...
begin
  ...
  begin
    ...
    if SBModel.ItemIndex <> Model then
      SBModel.ItemIndex := Model;
  end;
end;
...
begin
  ...
  with TComboDataModule(Owner) do
  begin
    if Parameter[2] <> DialBias.Value then
      Parameter[2] := DialBias.Value;
  end;
end;
...
begin
  ...
  with TComboDataModule(Owner) do
  begin
    if Parameter[1] <> DialDrive.Value then
      Parameter[1] := DialDrive.Value;
  end;
end;
...
begin
  ...
  with TComboDataModule(Owner) do
  begin
    if Parameter[3] <> DialOutput.Value then
      Parameter[3] := DialOutput.Value;
  end;
end;
...
begin
  ...
  with TComboDataModule(Owner) do
  begin
    if Parameter[5] <> DialFrequency.Value then
      Parameter[5] := DialFrequency.Value;
  end;
end;
...
begin
  ...
  with TComboDataModule(Owner) do
  begin
    if Parameter[6] <> DialResonance.Value then
      Parameter[6] := DialResonance.Value;
  end;
end;
