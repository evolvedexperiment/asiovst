...
type
  ...
  protected
    ...
    property Items[Index: Integer]: TGuiPNGCollectionItem
      read GetPngItems; default;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  published
    property PNGs: TGuiImageCollection read FImageCollection
      write FImageCollection;
  end;
...
procedure TGuiPNGCollectionItem.SetPng(const Value
...
begin
  ...
  if Assigned(FImageCollection) then
    for Index := 0 to FImageCollection.Count - 1 do
      if FImageCollection[Index] is TGuiPNGCollectionItem then
        TGuiPNGCollectionItem(FImageCollection[Index]).BuildPixelMap;
end;
