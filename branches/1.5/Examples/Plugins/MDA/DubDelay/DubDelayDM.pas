...
procedure TDubDelayDataModule.ParameterLimiterChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if (Value > 0.98) then
    FLowThreshold := 0 // Limiter
  else
  begin
...
procedure TDubDelayDataModule.ParameterGateThresholdChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if (Value < 0.02) then
    FXThreshold := 0 // Expander
  else
  begin
...
procedure TDubDelayDataModule.ParameterGateReleaseChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  FXRate := 1 - Power(10, -2 - 3.3 * Value);
end;

procedure TDubDelayDataModule.ParameterGateAttackChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  FGainAtt := Power(10, -0.002 - 3 * Value);
end;

procedure TDubDelayDataModule.ParameterAttackChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  FAttack := Power(10, -0.002 - 2 * Value);
end;

procedure TDubDelayDataModule.ParameterMixChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  FDry := 1 - Value;
  TrimChanged;
...
procedure TDubDelayDataModule.ParameterOutputChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  TrimChanged;
end;

procedure TDubDelayDataModule.ParameterRatioChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
...
procedure TDubDelayDataModule.ParameterThresholdChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
...
procedure TDubDelayDataModule.VSTModuleParameterChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  FMode := 0;
...
procedure TDubDelayDataModule.VSTModuleProcess(const Inputs,
