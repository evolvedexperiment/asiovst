...
begin
  ...
  begin
    if ParameterByName['Attack'] <> DialAttack.Value then
      ParameterByName['Attack'] := DialAttack.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Balance'] <> DialBalance.Value then
      ParameterByName['Balance'] := DialBalance.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Compression Mix'] <> DialCompression.Value then
      ParameterByName['Compression Mix'] := DialCompression.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Divider'] <> DialDivide.Value then
      ParameterByName['Divider'] := DialDivide.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Split Frequency'] <> DialFrequency.Value then
      ParameterByName['Split Frequency'] := DialFrequency.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Split Order'] <> DialOrder.Value then
      ParameterByName['Split Order'] := DialOrder.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Ratio'] <> DialRatio.Value then
      ParameterByName['Ratio'] := DialRatio.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Release'] <> DialRelease.Value then
      ParameterByName['Release'] := DialRelease.Value;
  end;
end;
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Shape'] <> DialShape.Value then
...
begin
  with TBassExtenderModule(Owner) do
  begin
    if ParameterByName['Threshold'] <> DialThreshold.Value then
      ParameterByName['Threshold'] := DialThreshold.Value;
  end;
end;
...
begin
  ...
  begin
    ...
    if DialAttack.Value <> Attack then
      DialAttack.Value := Attack;
    if Attack < 1000 then
      LbAttackValue.Caption := FloatToStrF(Attack, ffGeneral, 3, 3) + ' µs'
    else
      LbAttackValue.Caption := FloatToStrF(1E-3 * Attack, ffGeneral, 3,
        3) + ' ms';
  end;
end;
...
begin
  ...
  begin
    ...
    if DialBalance.Value <> Balance then
      DialBalance.Value := Balance;
    // Balance := Round(1E5 * Balance) * 1E-5;
    LbBalanceValue.Caption := FloatToStrF(RoundTo(Balance, -2), ffGeneral,
      3, 4) + '%';
  end;
end;
...
begin
  ...
  begin
    ...
    if DialCompression.Value <> Compression then
      DialCompression.Value := Compression;
    LbCompressionValue.Caption := FloatToStrF(RoundTo(Compression, -2),
      ffGeneral, 3, 3) + '%';
  end;
end;
...
begin
  ...
  begin
    ...
    if DialDivide.Value <> Divider then
      DialDivide.Value := Divider;
...
begin
  ...
  begin
    ...
    if DialRatio.Value <> Ratio then
      DialRatio.Value := Ratio;
    if Ratio = 1000 then
      LbRatioValue.Caption := '1 : oo'
    else
      LbRatioValue.Caption := '1 : ' + FloatToStrF(Ratio, ffGeneral, 3, 4);
  end;
end;
...
begin
  ...
  begin
    ...
    if DialRelease.Value <> Release then
      DialRelease.Value := Release;
    if Release < 1000 then
      LbReleaseValue.Caption := FloatToStrF(Release, ffGeneral, 3, 2) + ' ms'
    else
      LbReleaseValue.Caption := FloatToStrF(Release * 1E-3, ffGeneral, 3,
        2) + ' s';
  end;
end;
...
begin
  ...
  begin
    ...
    LbShapeValue.Caption := FloatToStrF(RoundTo(Shape, -2), ffGeneral,
      3, 2) + '%';
  end;
end;
...
begin
  ...
  begin
    ...
    if Frequency < 1000 then
      LbFrequencyValue.Caption := FloatToStrF(Frequency, ffGeneral, 3,
        2) + ' Hz'
    else
      LbFrequencyValue.Caption := FloatToStrF(Frequency * 1E-3, ffGeneral, 3,
        2) + ' kHz';
  end;
end;
...
begin
  ...
  begin
    ...
    if DialThreshold.Value <> Threshold then
      DialThreshold.Value := Threshold;
    Threshold := Round(1E4 * Threshold) * 1E-4;
    LbThresholdValue.Caption := FloatToStrF(RoundTo(Threshold, -2), ffGeneral,
      3, 4) + 'dB';
  end;
end;
