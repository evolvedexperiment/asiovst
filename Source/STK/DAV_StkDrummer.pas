...
const
  genMIDIMap: array [0 .. 127] of Byte = (0, 0, 0, 0, 0, 0, 0, 0, // 0-7
...
const
  waveNames: array [0 .. CDrumWaveCount - 1] of TFileName = ('dope.wav',
    'bassdrum.wav', 'snardrum.wav', 'tomlowdr.wav', 'tommiddr.wav',
    'tomhidrm.wav', 'hihatcym.wav', 'ridecymb.wav', 'crashcym.wav',
    'cowbell1.wav', 'tambourn.wav');
...
begin
  ...
  begin
    ...
    FWaves[FNSounding - 1] := TStkWavePlayer.Create(SampleRate,
      waveNames[genMIDIMap[notenum]]);
