...
procedure TLightweightUpwardCompressorDataModule.VSTModuleClose
  (Sender: TObject);
begin
...
procedure TLightweightUpwardCompressorDataModule.VSTModuleEditOpen
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateMakeUp;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateStereo;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateLimit;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateAutoMakeUpGain;
end;

function TLightweightUpwardCompressorDataModule.GetLightweightUpwardCompressor
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateAttack;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateRelease;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateThreshold;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateRatio;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightUpwardCompressor then
    TFmLightweightUpwardCompressor(EditorForm).UpdateKnee;
end;

procedure TLightweightUpwardCompressorDataModule.VSTModuleProcessStereo
...
procedure TLightweightUpwardCompressorDataModule.VSTModuleProcessMono
  (const Inputs, Outputs: TDAVArrayOfSingleFixedArray;
  const SampleFrames: Cardinal);
var
  Sample: Integer;
...
procedure TLightweightUpwardCompressorDataModule.VSTModuleProcessStereoSoftClip
  (const Inputs, Outputs: TDAVArrayOfSingleFixedArray;
  const SampleFrames: Cardinal);
var
  Sample: Integer;
...
procedure TLightweightUpwardCompressorDataModule.VSTModuleProcessMonoSoftClip
  (const Inputs, Outputs: TDAVArrayOfSingleFixedArray;
  const SampleFrames: Cardinal);
var
  Sample: Integer;
...
procedure TLightweightUpwardCompressorDataModule.VSTModuleSampleRateChange
