...
type
  ...
  TSEButterworthPins = (pinInput, pinOutputLow, pinOutputHigh, pinFrequency,
    pinOrder);
  ...
  TSEControlableButterworthSplitterModule = class
  ...
  TSEAutomatableButterworthSplitterModule = class
    (TSEStaticButterworthSplitterModule)
  protected
...
class procedure TSEStaticButterworthSplitterModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
...
function TSEStaticButterworthSplitterModule.GetPinProperties
...
procedure TSEStaticButterworthSplitterModule.PlugStateChange
...
class procedure TSEControlableButterworthSplitterModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
function TSEAutomatableButterworthSplitterModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case TSEButterworthPins(Index) of
