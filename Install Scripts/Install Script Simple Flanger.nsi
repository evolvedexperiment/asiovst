...
Section "Simple Flanger VST-Plugin" SecVstPlugins
  SetOutPath "$INSTDIR"
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\UninstallSimpleFlanger.exe"
SectionEnd
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecVstPlugins ${LANG_ENGLISH} "Simple Flanger VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\SimpleFlanger.dll"
