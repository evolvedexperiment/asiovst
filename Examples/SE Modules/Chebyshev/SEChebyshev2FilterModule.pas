...
type
  ...
  TSEControlableChebyshev2FilterLPModule = class
  ...
  TSEControlableChebyshev2FilterHPModule = class
  ...
  TSEAutomatebleChebyshev2FilterLPModule = class
  ...
  TSEAutomatebleChebyshev2FilterHPModule = class
    (TSEAutomatebleChebyshev2FilterModule)
  protected
    class function GetModueName: AnsiString; override;
  public
  ...
  TSEAutomatebleXChebyshev2FilterModule = class
    (TSEAutomatebleChebyshev2FilterModule)
  public
    procedure SubProcess(const BufferOffset, SampleFrames: Integer); override;
  end;

  TSEAutomatebleXChebyshev2FilterLPModule = class
  ...
  TSEAutomatebleXChebyshev2FilterHPModule = class
    (TSEAutomatebleChebyshev2FilterModule)
  protected
    class function GetModueName: AnsiString; override;
  public
...
class procedure TSECustomChebyshev2FilterModule.GetModuleProperties
...
function TSECustomChebyshev2FilterModule.GetPinProperties(const Index: Integer;
...
procedure TSECustomChebyshev2FilterModule.SubProcessStatic(const BufferOffset,
...
constructor TSEStaticChebyshev2FilterModule.Create(SEAudioMaster
...
procedure TSEStaticChebyshev2FilterModule.PlugStateChange
...
begin
  ...
  case TSEChebyshev2FilterPins(CurrentPin.PinID) of
    ...
    pinCorrectFrequency:
      FFilter.FixFrequency := FCorrectFreq;
    pinStopband:
      FFilter.Stopband := FStopband;
  end;
  inherited;
end;
...
constructor TSEStaticChebyshev2FilterLPModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
  inherited;
...
constructor TSEStaticChebyshev2FilterHPModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
  inherited;
...
constructor TSEAutomatebleChebyshev2FilterModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FOrder := 4;
...
begin
  ...
  case TSEChebyshev2FilterPins(CurrentPin.PinID) of
    ...
    pinCorrectFrequency:
      FFilter.FixFrequency := FCorrectFreq;
    pinFrequency, pinStopband:
      if (Pin[2].Status <> stRun) and (Pin[4].Status <> stRun) then
        OnProcess := SubProcessStatic
      else
        OnProcess := SubProcess;
  end;
