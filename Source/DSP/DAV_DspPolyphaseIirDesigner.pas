...
type
  ...
  private
    class procedure ComputeTransitionParam(out K, Q: Double;
      const Transition: Double);
    class function ComputeOrder(const Attenuation, Q: Double): Integer;
    class function ComputeAttenuation(const Q: Double;
      const Order: Integer): Double;
    class function ComputeCoefficient(const Index: Integer; const K, Q: Double;
      const Order: Integer): Double;
    class function ComputeACCNum(const Q: Double;
      const Order, c: Integer): Double;
    class function ComputeACCDen(const Q: Double;
      const Order, c: Integer): Double;
  public
    class function ComputeNbrOfCoeffsFromPrototype(const Attenuation,
      Transition: Double): Integer;
    class function ComputeAttenuationFromOrderTBW(const NbrOfCoeffs: Integer;
      const Transition: Double): Double;
    class function ComputeCoeffs(Coeffs: TDAVDoubleDynArray;
      const Attenuation, Transition: Double): Integer;
    class procedure ComputeCoeffsSpecOrderTBW(const Coeffs: TDAVDoubleDynArray;
      const NbrOfCoeffs: Integer; const Transition: Double);
  end;
...
class procedure TPolyphaseIirDesigner.ComputeTransitionParam(out K, Q: Double;
  const Transition: Double);
var
  kksqrt: Double;
  e, e4: Double;
...
class function TPolyphaseIirDesigner.ComputeOrder(const Attenuation,
  Q: Double): Integer;
var
  a, attn_p2: Double;
begin
