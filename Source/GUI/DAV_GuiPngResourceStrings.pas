...
resourcestring
  ...
  RCStrBitDepthTranscodingError =
    'Bit depth may not be specified directly yet!';
  RCStrChunkSizeTooSmall = 'Chunk size too small!';
  RCStrColorTypeTranscodingError =
    'Color Type may not be specified directly yet!';
  RCStrDataIncomplete = 'Data not complete';
  RCStrDirectCompressionMethodSetError =
    'Compression Method may not be specified directly yet!';
  RCStrDirectFilterMethodSetError =
    'Filter Method may not be specified directly yet!';
  ...
  RCStrDirectInterlaceMethodSetError =
    'Interlace Method may not be specified directly yet!';
  ...
  RCStrSeveralPhysicalPixelDimensionChunks =
    'Several physical pixel dimenson chunks found';
  RCStrSeveralSignificantBitsChunksFound =
    'Several significant bits chunks found';
