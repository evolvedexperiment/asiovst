...
begin
  PreDefined := AnsiString(GWindowFunctions[Round(Parameter[Index])
    ].GetWindowFunctionName);
end;

procedure TWeightingFiltersDataModule.StringToWindowParameter(Sender: TObject;
...
procedure TWeightingFiltersDataModule.ParameterTypeDisplay(Sender: TObject;
...
procedure TWeightingFiltersDataModule.ParameterTypeChange(Sender: TObject;
...
begin
  ...
  if not Assigned(FAnaloguePrototype) then
    Exit;
