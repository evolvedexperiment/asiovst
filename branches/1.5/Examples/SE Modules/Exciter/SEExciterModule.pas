...
constructor TCustomSEExciterModule.Create(SEAudioMaster
...
procedure TCustomSEExciterModule.SubProcessStatic(const BufferOffset,
...
class procedure TCustomSEExciterModule.GetModuleProperties
...
function TCustomSEExciterModule.GetPinProperties(const Index: Integer;
...
begin
  ...
  case TSEExciterPins(CurrentPin.PinID) of
    pinInputLevel:
      FExciter.InputLevel := FInputLevel^[0];
    pinLowFrequencyLevel:
      FExciter.LowFrequencyLevel := FLowFrequencyLevel^[0];
    pinHighFrequencyLevel:
      FExciter.HighFrequencyLevel := FHighFrequencyLevel^[0];
    pinHarmonicsLevel:
      FExciter.HarmonicsLevel := FHarmonicsLevel^[0];
    pinFrequency:
      FExciter.Frequency := FFrequency^[0];
  end;
end;
