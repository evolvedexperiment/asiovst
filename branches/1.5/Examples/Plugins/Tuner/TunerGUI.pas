...
begin
  ...
  begin
    ...
    TTunerDataModule(Owner).Parameter[0] := 1;
  end;
  if Sender <> LbA then
  ...
  begin
    ...
    TTunerDataModule(Owner).Parameter[0] := 2;
  end;
  if Sender <> LbD then
  ...
  begin
    ...
    TTunerDataModule(Owner).Parameter[0] := 3;
  end;
  if Sender <> LbG then
  ...
  begin
    ...
    TTunerDataModule(Owner).Parameter[0] := 4;
  end;
  if Sender <> LbH then
  ...
  begin
    ...
    TTunerDataModule(Owner).Parameter[0] := 5;
  end;
  if Sender <> LbE then
  ...
  begin
    ...
    TTunerDataModule(Owner).Parameter[0] := 6;
  end;
end;
