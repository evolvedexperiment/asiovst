...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        PixelLine[0, x].B := (PixelLine[1, 2 * x].B + PixelLine[2, 2 * x].B +
          PixelLine[1, 2 * x + 1].B + PixelLine[2, 2 * x + 1].B) div 4;
        PixelLine[0, x].G := (PixelLine[1, 2 * x].G + PixelLine[2, 2 * x].G +
          PixelLine[1, 2 * x + 1].G + PixelLine[2, 2 * x + 1].G) div 4;
        PixelLine[0, x].R := (PixelLine[1, 2 * x].R + PixelLine[2, 2 * x].R +
          PixelLine[1, 2 * x + 1].R + PixelLine[2, 2 * x + 1].R) div 4;
        PixelLine[0, x].A := (PixelLine[1, 2 * x].A + PixelLine[2, 2 * x].A +
          PixelLine[1, 2 * x + 1].A + PixelLine[2, 2 * x + 1].A) div 4;
      end;
    end;
  end;
end;
