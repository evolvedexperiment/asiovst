...
type
  TGuiZoneMousePosType = set of (mptOutside, mptInZone, mptOnLowestKey,
    mptOnHighestKey, mptOnLowestBorder, mptOnHighestBorder);
  ...
  TGuiOnMouseUpOnMidiKey = procedure(Sender: TObject; KeyNr: Byte;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer) of object;
  TGuiOnMouseDownOnMidiKey = procedure(Sender: TObject; KeyNr: Byte;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer) of object;

  TGuiOnMouseUpOnKeyZoneBar = procedure(Sender: TObject; KeyNr: Byte;
    Zone: TGuiKeyZoneItem; MouseOverType: TGuiZoneMousePosType;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer) of object;
  TGuiOnMouseDownOnKeyZoneBar = procedure(Sender: TObject; KeyNr: Byte;
    Zone: TGuiKeyZoneItem; MouseOverType: TGuiZoneMousePosType;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer) of object;

  TGuiOnZoneBarMouseEnter = procedure(Sender: TObject; KeyNr: Byte;
    Shift: TShiftState; X, Y: Integer) of object;
  TGuiOnZoneBarMouseLeave = TNotifyEvent;

  TGuiOnZoneMouseEnter = procedure(Sender: TObject; Zone: TGuiKeyZoneItem;
    Shift: TShiftState; X, Y: Integer) of object;
  TGuiOnZoneMouseLeave = procedure(Sender: TObject; Zone: TGuiKeyZoneItem)
    of object;
  TGuiOnZoneMouseOverChanged = procedure(Sender: TObject; KeyNr: Byte;
    Zone: TGuiKeyZoneItem; MouseOverType: TGuiZoneMousePosType;
    Shift: TShiftState; X, Y: Integer) of object;
  TGuiOnZoneSelectionChanged = procedure(Sender: TObject; Zone: TGuiKeyZoneItem)
    of object;

  TGuiOnKeyMouseEnter = procedure(Sender: TObject; KeyNr: Byte;
    Shift: TShiftState; X, Y: Integer) of object;
  TGuiOnKeyMouseLeave = procedure(Sender: TObject; KeyNr: Byte) of object;

  TGuiOnStartZoneBarDragging = procedure(Sender: TObject; KeyNr: Integer;
    var DragInfo: TGuiZbMouseDragInfo; Shift: TShiftState; X, Y: Integer)
    of object;
  TGuiOnMoveZoneBarDragging = procedure(Sender: TObject; KeyNr: Integer;
    var DragInfo: TGuiZbMouseDragInfo; Shift: TShiftState; X, Y: Integer)
    of object;
  TGuiOnEndZoneBarDragging = procedure(Sender: TObject;
    var DragInfo: TGuiZbMouseDragInfo; Shift: TShiftState; X, Y: Integer)
    of object;

  TGuiOnStartKeyDragging = procedure(Sender: TObject; KeyNr: Integer;
    var DragInfo: TGuiKbMouseDragInfo; Shift: TShiftState; X, Y: Integer)
    of object;
  TGuiOnMoveKeyDragging = procedure(Sender: TObject; KeyNr: Integer;
    var DragInfo: TGuiKbMouseDragInfo; Shift: TShiftState; X, Y: Integer)
    of object;
  TGuiOnEndKeyDragging = procedure(Sender: TObject;
    var DragInfo: TGuiKbMouseDragInfo; Shift: TShiftState; X, Y: Integer)
    of object;

  TGuiOnNoteOn = procedure(Sender: TObject; KeyNr: Byte; Velocity: Single)
    of object;
  TGuiOnNoteOff = procedure(Sender: TObject; KeyNr: Byte) of object;

  TGuiOnGetKeyColorEvent = procedure(Sender: TObject; KeyNr: Byte;
    var KeyColor: TColor; IsBlackKey: Boolean) of object;
  ...
  protected
    ...
    function CalculateLights(Color: TColor; DoubledHeight: Boolean = False;
      KeyPressed: Boolean = False): TGuiColorRect; virtual;
    ...
    procedure KeyMouseEnter(KeyNr: Byte; Shift: TShiftState;
      X, Y: Integer); dynamic;
    ...
    procedure StartZoneBarDragging(KeyNr: Integer; Zone: TGuiKeyZoneItem;
      MouseOverType: TGuiZoneMousePosType; DragButton: TMouseButton;
      Shift: TShiftState; X, Y: Integer); dynamic;
    procedure MoveZoneBarDragging(KeyNr: Integer; Shift: TShiftState;
      X, Y: Integer); dynamic;
    procedure EndZoneBarDragging(Shift: TShiftState; X, Y: Integer); dynamic;

    procedure StartKeyDragging(KeyNr: Integer; DragButton: TMouseButton;
      Shift: TShiftState; X, Y: Integer); dynamic;
    procedure MoveKeyDragging(KeyNr: Integer; Shift: TShiftState;
      X, Y: Integer); dynamic;
    procedure EndKeyDragging(Shift: TShiftState; X, Y: Integer); dynamic;

    procedure ZoneMouseActivity(Action: TGuiKbMouseAction; KeyNr: Integer;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer); dynamic;
    procedure ZoneMouseEnter(Zone: TGuiKeyZoneItem; Shift: TShiftState;
      X, Y: Integer); dynamic;
    procedure ZoneMouseLeave(Zone: TGuiKeyZoneItem); dynamic;
    procedure ZoneMouseOverChanged(KeyNr: Byte; Zone: TGuiKeyZoneItem;
      MouseOverType: TGuiZoneMousePosType; Shift: TShiftState;
      X, Y: Integer); dynamic;
    procedure ZoneBarMouseEnter(KeyNr: Byte; Shift: TShiftState;
      X, Y: Integer); dynamic;
    procedure ZoneBarMouseLeave; dynamic;
    procedure ZoneSelectionChanged(Zone: TGuiKeyZoneItem = nil); dynamic;

    procedure MouseUpOnMidiKey(KeyNr: Byte; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer); dynamic;
    procedure MouseDownOnMidiKey(KeyNr: Byte; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer); dynamic;

    procedure MouseUpOnKeyZoneBar(KeyNr: Byte; Zone: TGuiKeyZoneItem;
      MouseOverType: TGuiZoneMousePosType; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer); dynamic;
    procedure MouseDownOnKeyZoneBar(KeyNr: Byte; Zone: TGuiKeyZoneItem;
      MouseOverType: TGuiZoneMousePosType; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer); dynamic;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure SetKeyColor(FromKey, ToKey: Byte; BaseColor: TColor = clNone;
      Over: TColor = clNone; Pressed: TColor = clNone);
    ...
    procedure AllNotesOff(MouseTriggeredOnly: Boolean = True;
      ExceptKey: Integer = -1);
    procedure UpdateBuffer; override;
    function MousePosToKey(X, Y: Integer; CheckYPos: Boolean = True)
      : Integer; dynamic;
    function GetZoneMouseOverType(X: Integer; KeyNr: Integer = -1;
      Zone: TGuiKeyZoneItem = nil): TGuiZoneMousePosType;
    function ScreenCoordOnKey(X, Y: Integer; KeyNr: Integer;
      CheckYPos: Boolean = True): Boolean; dynamic;
    property Keys: TGuiKeyArray read FKeys;

    property KeyDownMode: TGuiKeyDownMode read FKeyDownMode
      write SetKeyDownMode;
    property BorderColor: TColor read FBorderColor write SetBorderColor
      default clBlack;
    property KeySeparatorColor: TColor read FKeySeparatorColor
      write SetKeySeparatorColor default clBlack;
    property ZoneSeparatorColor: TColor read FZoneSeparatorColor
      write SetZoneSeparatorColor default clBlack;
    property ZoneBarColor: TColor read FZoneBarColor write SetZoneBarColor
      default clWhite;
    property ZoneBarHoverColor: TColor read FZoneBarHoverColor
      write SetZoneBarHoverColor default $00CCEEFF;
    property BlackKeyColor: TColor read FBlackKeyColor write SetBlackKeyColor
      default $00333333;
    property BlackKeyHoverColor: TColor read FBlackKeyHoverColor
      write SetBlackKeyHoverColor default $00666666;
    property BlackKeyPressedColor: TColor read FBlackKeyPressedColor
      write SetBlackKeyPressedColor default clSilver;
    property WhiteKeyColor: TColor read FWhiteKeyColor write SetWhiteKeyColor
      default $00F8F8F8;
    property WhiteKeyHoverColor: TColor read FWhiteKeyHoverColor
      write SetWhiteKeyHoverColor default $00DDDDDD;
    property WhiteKeyPressedColor: TColor read FWhiteKeyPressedColor
      write SetWhiteKeyPressedColor default clSilver;

    property CursorKeys: TCursor read FCursorKeys write FCursorKeys
      default crHandPoint;
    property CursorZoneBar: TCursor read FCursorZoneBar write FCursorZoneBar
      default crDefault;
    property CursorZone: TCursor read FCursorZone write FCursorZone
      default crSize;
    property CursorZoneBorder: TCursor read FCursorZoneBorder
      write FCursorZoneBorder default crSizeWE;

    property Height3d: Single read FHeight3D write SetHeight3d;
    property BlackKeyHeight: Single read FBlackKeyHeight
      write SetBlackKeyHeight;
    ...
    property IncludeLastOctave: Boolean read FIncludeLastOctave
      write SetIncludeLastOctave default False;
    ...
    property KeyZoneHeight: Integer read FKeyZoneHeight write SetKeyZoneHeight
      default 10;
    property AllowKeyDragging: Boolean read FAllowKeyDragging
      write FAllowKeyDragging default True;

    property OnGetKeyColor: TGuiOnGetKeyColorEvent read FOnGetKeyColor
      write FOnGetKeyColor;

    property OnMouseUpOnMidiKey: TGuiOnMouseUpOnMidiKey read FOnMouseUpOnMidiKey
      write FOnMouseUpOnMidiKey;
    property OnMouseUpOnKeyZoneBar: TGuiOnMouseUpOnKeyZoneBar
      read FOnMouseUpOnKeyZoneBar write FOnMouseUpOnKeyZoneBar;
    property OnMouseDownOnMidiKey: TGuiOnMouseDownOnMidiKey
      read FOnMouseDownOnMidiKey write FOnMouseDownOnMidiKey;
    property OnMouseDownKeyZoneBar: TGuiOnMouseDownOnKeyZoneBar
      read FOnMouseDownOnKeyZoneBar write FOnMouseDownOnKeyZoneBar;

    property OnZoneBarMouseEnter: TGuiOnZoneBarMouseEnter
      read FOnZoneBarMouseEnter write FOnZoneBarMouseEnter;
    property OnZoneBarMouseLeave: TGuiOnZoneBarMouseLeave
      read FOnZoneBarMouseLeave write FOnZoneBarMouseLeave;
    property OnZoneMouseEnter: TGuiOnZoneMouseEnter read FOnZoneMouseEnter
      write FOnZoneMouseEnter;
    property OnZoneMouseLeave: TGuiOnZoneMouseLeave read FOnZoneMouseLeave
      write FOnZoneMouseLeave;
    property OnZoneMouseOverChanged: TGuiOnZoneMouseOverChanged
      read FOnZoneMouseOverChanged write FOnZoneMouseOverChanged;
    property OnZoneSelectionChanged: TGuiOnZoneSelectionChanged
      read FOnZoneSelectionChanged write FOnZoneSelectionChanged;

    property OnKeyMouseEnter: TGuiOnKeyMouseEnter read FOnKeyMouseEnter
      write FOnKeyMouseEnter;
    property OnKeyMouseLeave: TGuiOnKeyMouseLeave read FOnKeyMouseLeave
      write FOnKeyMouseLeave;

    property OnStartZoneBarDragging: TGuiOnStartZoneBarDragging
      read FOnStartZoneBarDragging write FOnStartZoneBarDragging;
    property OnMoveZoneBarDragging: TGuiOnMoveZoneBarDragging
      read FOnMoveZoneBarDragging write FOnMoveZoneBarDragging;
    property OnEndZoneBarDragging: TGuiOnEndZoneBarDragging
      read FOnEndZoneBarDragging write FOnEndZoneBarDragging;

    property OnStartKeyDragging: TGuiOnStartKeyDragging read FOnStartKeyDragging
      write FOnStartKeyDragging;
    property OnMoveKeyDragging: TGuiOnMoveKeyDragging read FOnMoveKeyDragging
      write FOnMoveKeyDragging;
    property OnEndKeyDragging: TGuiOnEndKeyDragging read FOnEndKeyDragging
      write FOnEndKeyDragging;
...
begin
  ...
  for i := 0 to CKeyboardHighestKey do
    ...
    begin
      if i > LastKey then
        Area := Rect(OversamplingFactor * Width - 1, 0,
          OversamplingFactor * Width - 1, 0)
      else
        Area := Rect(0, 0, 0, 0);
  ...
  if FShowKeyZones then
    TopMargin := OversamplingFactor * (FKeyZoneHeight + 2)
  else
    TopMargin := 1;
  ...
  begin
    ...
    begin
      FKeys[i].Area := Rect(LastRightBorder + 2, TopMargin,
        Round((cnt + 1) * KeyWidth) - 1, BottomMargin);
  ...
  // set black keys
  // -------------------------------------------
  if not FIncludeLastOctave then
    KeyWidth := 0;
  KeyWidth := (OversamplingFactor * Width - 2 - KeyWidth) / (FNumOctaves * 12);

  BottomMargin := Round((OversamplingFactor * Height - TopMargin) *
    FBlackKeyHeight + TopMargin);
  ...
  begin
    if (i mod 12) in [1, 3, 6, 8, 10] then
    begin
      FKeys[i].Area := Rect(Round(cnt * KeyWidth + 2), TopMargin,
...
function TCustomGuiMidiKeys.CalculateLights(Color: TColor;
  DoubledHeight, KeyPressed: Boolean): TGuiColorRect;
var
  r1, g1, b1: Integer;
  r2, g2, b2: Integer;
  TmpHeight: Single;
begin
  ...
  Result.Left := Max(Min(r2, $FF), 0) shl 16 + Max(Min(g2, $FF), 0) shl 8 +
    Max(Min(b2, $FF), 0);
  ...
  Result.Right := Max(Min(r2, $FF), 0) shl 16 + Max(Min(g2, $FF), 0) shl 8 +
    Max(Min(b2, $FF), 0);
...
begin
  if ShowKeyZones and (FKeyZoneHeight < 1) then
    KeyZoneHeight := 10
  else
  begin
    CalculateVisibleKeys;
...
begin
  if not(csLoading in ComponentState) and not ShowKeyZones and
    (FKeyZoneHeight > 0) then
    FShowKeyZones := True;
  CalculateVisibleKeys;
  Invalidate;
end;
...
procedure TCustomGuiMidiKeys.SetKeyVelocity(FromKey, ToKey: Byte;
  Amount: Single);
var
  i, tmp: Byte;
begin
...
procedure TCustomGuiMidiKeys.SetKeyColor(FromKey, ToKey: Byte;
  BaseColor, Over, Pressed: TColor);
var
  i, tmp: Byte;
begin
  if ToKey < FromKey then
...
begin
  ...
  if KeyNr < CKeyboardHighestKey then
    Include(FKeys[KeyNr].Flags, kfPressed);

  if FRedrawTimer.Interval < 1 then
    Invalidate
  else
    FTimerMustRedraw := True;
end;

procedure TCustomGuiMidiKeys.ReleaseKey(KeyNr: Byte;
  ReleaseMouseTriggered: Boolean);
begin
  if KeyNr < CKeyboardHighestKey then
...
begin
  ...
  if kfBlackKey in FKeys[KeyNr].Flags then
    exit;
  if KeyNr > 0 then
      ...
      if FKeyZones.Items[i].Visible then
        ...
        begin
          ...
          begin
            ...
            Dec(LowBound);
            Inc(HighBound);
            MoveTo(OversamplingFactor * LowBound, 1);
            LineTo(OversamplingFactor * LowBound, OversamplingFactor *
              (FKeyZoneHeight + 1));
            MoveTo(OversamplingFactor * HighBound, 1);
            LineTo(OversamplingFactor * HighBound,
              OversamplingFactor * (FKeyZoneHeight + 1));
          end;
        end;
  end;
...
procedure TCustomGuiMidiKeys.DrawSingleKey(Bitmap: TBitmap;
  CurKey: TGuiSingleKey);
var
  KeyColor: TColor;
  LightAndShadow: TGuiColorRect;
begin
  if kfPressed in CurKey.Flags then
    KeyColor := CurKey.PressedColor
  else if kfMouseOver in CurKey.Flags then
    KeyColor := CurKey.OverColor
  else
    KeyColor := CurKey.BaseColor;
  ...
  begin
    ...
    begin
      if kfPressed in CurKey.Flags then
        KeyColor := FBlackKeyPressedColor
      else if kfMouseOver in CurKey.Flags then
        KeyColor := FBlackKeyHoverColor
      else
        KeyColor := FBlackKeyColor;
    end;
  end
  else
  begin
    ...
    begin
      if kfPressed in CurKey.Flags then
        KeyColor := FWhiteKeyPressedColor
      else if kfMouseOver in CurKey.Flags then
        KeyColor := FWhiteKeyHoverColor
      else
        KeyColor := FWhiteKeyColor;
    end;
  end;
  ...
  begin
    ...
    LightAndShadow := CalculateLights(KeyColor, kfBlackKey in CurKey.Flags,
  ...
  begin
    ...
    Pen.Color := LightAndShadow.Top;
    LineTo(CurKey.Area.Right, CurKey.Area.Top);
    Pen.Color := LightAndShadow.Right;
    LineTo(CurKey.Area.Right, CurKey.Area.Bottom);
    Pen.Color := LightAndShadow.Bottom;
    LineTo(CurKey.Area.Left, CurKey.Area.Bottom);
    Pen.Color := LightAndShadow.Left;
    LineTo(CurKey.Area.Left, CurKey.Area.Top);
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      then
        DrawSingleKey(Bitmap, FKeys[i]);
      if (i > 0) and (FKeys[i - 1].Flags * CDrawFlags = CDrawFlags) then
        DrawSingleKey(Bitmap, FKeys[i - 1]);
    end;
  end;
end;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        LineTo(OversamplingFactor * Width - 1, OversamplingFactor *
          (FKeyZoneHeight + 1));
      end;
...
function TCustomGuiMidiKeys.ScreenCoordOnKey(X, Y: Integer; KeyNr: Integer;
  CheckYPos: Boolean): Boolean;
begin
  Result := False;
  with FKeys[KeyNr] do
    if kfVisible in Flags then
    begin
      if (X * OversamplingFactor <= Area.Right) and
        (X * OversamplingFactor >= Area.Left) then
      begin
        ...
        if CheckYPos then
          Result := (Y * OversamplingFactor <= Area.Bottom) and
            (Y * OversamplingFactor >= Area.Top)
        else
          Result := True;
      end;
    end;
...
function TCustomGuiMidiKeys.MousePosToKey(X, Y: Integer;
  CheckYPos: Boolean): Integer;
var
  i: Byte;
begin
  Result := -1;
  if (X < 1) or (X > Width - 2) then
    exit;
...
begin
  ...
  if Assigned(FOnNoteOn) then
    FOnNoteOn(Self, KeyNr, FKeys[KeyNr].Velocity);
end;

procedure TCustomGuiMidiKeys.FireNoteOff(KeyNr: Byte);
begin
  if not(kfPressed in FKeys[KeyNr].Flags) then
    exit;
  ...
  if Assigned(FOnNoteOff) then
    FOnNoteOff(Self, KeyNr);
end;

procedure TCustomGuiMidiKeys.AllNotesOff(MouseTriggeredOnly: Boolean;
  ExceptKey: Integer);
var
  i: Integer;
begin
  for i := 0 to CKeyboardHighestKey do
    if (i <> ExceptKey) and (kfPressed in FKeys[i].Flags) then
      if (MouseTriggeredOnly and (kfByMouse in FKeys[i].Flags) and
        not(kfMousePinned in FKeys[i].Flags)) or not MouseTriggeredOnly then
        FireNoteOff(i);
end;
...
procedure TCustomGuiMidiKeys.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  mkey: Integer;
begin
  if Enabled and (X > 0) and (X < Width - 1) and (Y > 0) and (Y < Height - 1)
  then
  begin
    ...
    begin
      ...
      begin
        ...
        if not FMidiZoneBarDragging.isDragging then
          ZoneMouseActivity(kmaStartDrag, mkey, Button, Shift, X, Y);
      end;
    end
    else
    begin
      ...
      begin
        ...
        if not FMidiKeyDragging.isDragging and FAllowKeyDragging then
          StartKeyDragging(mkey, Button, Shift, X, Y);
      end;
    end;
...
procedure TCustomGuiMidiKeys.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  mkey: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        mkey := MousePosToKey(X, Y, False);
        if mkey >= 0 then
          ZoneMouseActivity(kmaUp, mkey, Button, Shift, X, Y);
      end
      else
      begin
        mkey := MousePosToKey(X, Y);
        if mkey >= 0 then
          MouseUpOnMidiKey(mkey, Button, Shift, X, Y);
      end;
    end;
...
begin
  ...
  begin
    ...
    else if FMidiKeyDragging.isDragging then
    begin
      if ((not FShowKeyZones and (Y > 0)) or
        (FShowKeyZones and (Y > FKeyZoneHeight))) and (Y < Height - 1) then
        mkey := MousePosToKey(X, Y)
      else
        mkey := MousePosToKey(X, Y, False);
    ...
    begin
      ...
      begin
        ...
        begin
          if mkey > -1 then
            ZoneBarMouseEnter(mkey, Shift, X, Y);
          MouseLeaveAllKeys;
        end;
...
{ midi key mouse tracking
  -------------------------------------------------------------------------------- }
procedure TCustomGuiMidiKeys.KeyMouseEnter(KeyNr: Byte; Shift: TShiftState;
  X, Y: Integer);
begin
  Cursor := CursorKeys;
  if Assigned(FOnKeyMouseEnter) then
    FOnKeyMouseEnter(Self, KeyNr, Shift, X, Y);
end;

procedure TCustomGuiMidiKeys.KeyMouseLeave(KeyNr: Byte);
begin
  if Assigned(FOnKeyMouseLeave) then
    FOnKeyMouseLeave(Self, KeyNr);
end;

{ midi key mouse up/down
  -------------------------------------------------------------------------------- }
procedure TCustomGuiMidiKeys.MouseUpOnMidiKey(KeyNr: Byte; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if Assigned(FOnMouseUpOnMidiKey) then
    FOnMouseUpOnMidiKey(Self, KeyNr, Button, Shift, X, Y);
end;

procedure TCustomGuiMidiKeys.MouseDownOnMidiKey(KeyNr: Byte;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  if (Button = mbRight) then
  begin
    if (kfPressed in FKeys[KeyNr].Flags) and
      (kfMousePinned in FKeys[KeyNr].Flags) then
      FireNoteOff(KeyNr)
    else
  ...
  if Assigned(FOnMouseDownOnMidiKey) then
    FOnMouseDownOnMidiKey(Self, KeyNr, Button, Shift, X, Y);
end;

{ midi key mouse dragging
  -------------------------------------------------------------------------------- }
procedure TCustomGuiMidiKeys.StartKeyDragging(KeyNr: Integer;
  DragButton: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  MouseLeaveAllKeys;
  ...
  if Assigned(FOnStartKeyDragging) then
    FOnStartKeyDragging(Self, KeyNr, FMidiKeyDragging, Shift, X, Y);
end;

procedure TCustomGuiMidiKeys.MoveKeyDragging(KeyNr: Integer; Shift: TShiftState;
  X, Y: Integer);
begin
  ...
  if Assigned(FOnMoveKeyDragging) then
    FOnMoveKeyDragging(Self, KeyNr, FMidiKeyDragging, Shift, X, Y);
  FMidiKeyDragging.LastKey := KeyNr;
end;
...
begin
  AllNotesOff;
  if Assigned(FOnEndKeyDragging) then
    FOnEndKeyDragging(Self, FMidiKeyDragging, Shift, X, Y);
  FMidiKeyDragging.isDragging := False;
end;

{ zone bar mouse tracking
  -------------------------------------------------------------------------------- }
function TCustomGuiMidiKeys.GetZoneMouseOverType(X: Integer; KeyNr: Integer;
  Zone: TGuiKeyZoneItem): TGuiZoneMousePosType;
var
  ZKeyArea: TRect;
  temp: Integer;
begin
  Result := [mptOutside];
  if KeyNr < 0 then
    KeyNr := MousePosToKey(X, 0, False)
  else if not ScreenCoordOnKey(X, 0, KeyNr, False) then
    exit;
  ...
  begin
    ...
    if X < ZKeyArea.Left + temp div 4 then
      Include(Result, mptOnLowestBorder);
  end;
  if KeyNr = Zone.HighestZoneKey then
  begin
    Include(Result, mptOnHighestKey);
    if X > ZKeyArea.Right - temp div 4 then
      Include(Result, mptOnHighestBorder);
  end;
end;

procedure TCustomGuiMidiKeys.ZoneMouseActivity(Action: TGuiKbMouseAction;
  KeyNr: Integer; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  Zone: TGuiKeyZoneItem;
...
begin
  ...
  begin
    ...
    case Action of
      ...
      kmaUp:
        MouseUpOnKeyZoneBar(KeyNr, nil, [mptOutside], Button, Shift, X, Y);

      kmaStartDrag:
        StartZoneBarDragging(KeyNr, nil, [mptOutside], Button, Shift, X, Y);
    end;
    exit;
  end;
  ...
  case Action of
    kmaMove:
      begin
        ...
        else if FZoneMouseOverType <> tmpMouseOverType then
          ZoneMouseOverChanged(KeyNr, Zone, tmpMouseOverType, Shift, X, Y);
      end;
    ...
    kmaDown:
      begin
        // new select
        if not Zone.Selected then
          ZoneSelectionChanged(Zone);
        MouseDownOnKeyZoneBar(KeyNr, Zone, tmpMouseOverType, Button,
          Shift, X, Y);
      end;

    kmaUp:
      MouseUpOnKeyZoneBar(KeyNr, Zone, tmpMouseOverType, Button, Shift, X, Y);

    kmaStartDrag:
      StartZoneBarDragging(KeyNr, Zone, tmpMouseOverType, Button, Shift, X, Y);
  end;
end;
...
begin
  for i := KeyZones.Count - 1 downto 0 do
    if (ExceptZone <> KeyZones.Items[i]) and KeyZones.Items[i].Selected then
      KeyZones.Items[i].Unselect(False);
end;
...
begin
  ...
  if Assigned(FOnZoneSelectionChanged) then
    FOnZoneSelectionChanged(Self, Zone);
end;
...
begin
  for i := KeyZones.Count - 1 downto 0 do
    if (ExceptZone <> KeyZones.Items[i]) and KeyZones.Items[i].IsMouseOver then
      ZoneMouseLeave(KeyZones.Items[i]);
end;

procedure TCustomGuiMidiKeys.ZoneMouseEnter(Zone: TGuiKeyZoneItem;
  Shift: TShiftState; X, Y: Integer);
begin
  Cursor := CursorZone;
  Zone.SetMouseOver(True, False);
  if Assigned(FOnZoneMouseEnter) then
    FOnZoneMouseEnter(Self, Zone, Shift, X, Y);
end;
...
begin
  ...
  if Assigned(FOnZoneMouseLeave) then
    FOnZoneMouseLeave(Self, Zone);
end;

procedure TCustomGuiMidiKeys.ZoneMouseOverChanged(KeyNr: Byte;
  Zone: TGuiKeyZoneItem; MouseOverType: TGuiZoneMousePosType;
  Shift: TShiftState; X, Y: Integer);
begin
  FZoneMouseOverType := MouseOverType;
  if (mptOnLowestBorder in MouseOverType) or
    (mptOnHighestBorder in MouseOverType) then
    Cursor := CursorZoneBorder
  else if mptInZone in MouseOverType then
    Cursor := CursorZone
  else
    Cursor := CursorZoneBar;
  if Assigned(FOnZoneMouseOverChanged) then
    FOnZoneMouseOverChanged(Self, KeyNr, Zone, MouseOverType, Shift, X, Y);
end;

procedure TCustomGuiMidiKeys.ZoneBarMouseEnter(KeyNr: Byte; Shift: TShiftState;
  X, Y: Integer);
begin
  Cursor := CursorZoneBar;
  FMidiZoneBarMouseOver := True;
  if Assigned(FOnZoneBarMouseEnter) then
    FOnZoneBarMouseEnter(Self, KeyNr, Shift, X, Y);
end;
...
begin
  ...
  FMidiZoneBarMouseOver := False;
  MouseLeaveAllZones;
  if Assigned(FOnZoneBarMouseLeave) then
    FOnZoneBarMouseLeave(Self);
end;

{ zone bar mouse up/down
  -------------------------------------------------------------------------------- }
procedure TCustomGuiMidiKeys.MouseUpOnKeyZoneBar(KeyNr: Byte;
  Zone: TGuiKeyZoneItem; MouseOverType: TGuiZoneMousePosType;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  if Assigned(FOnMouseUpOnKeyZoneBar) then
    FOnMouseUpOnKeyZoneBar(Self, KeyNr, Zone, MouseOverType, Button,
      Shift, X, Y);
end;

procedure TCustomGuiMidiKeys.MouseDownOnKeyZoneBar(KeyNr: Byte;
  Zone: TGuiKeyZoneItem; MouseOverType: TGuiZoneMousePosType;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  if Assigned(FOnMouseDownOnKeyZoneBar) then
    FOnMouseDownOnKeyZoneBar(Self, KeyNr, Zone, MouseOverType, Button,
      Shift, X, Y);
end;

{ zone bar dragging
  -------------------------------------------------------------------------------- }
procedure TCustomGuiMidiKeys.StartZoneBarDragging(KeyNr: Integer;
  Zone: TGuiKeyZoneItem; MouseOverType: TGuiZoneMousePosType;
  DragButton: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ...
  if Assigned(FOnStartZoneBarDragging) then
    FOnStartZoneBarDragging(Self, KeyNr, FMidiZoneBarDragging, Shift, X, Y);
end;

procedure TCustomGuiMidiKeys.MoveZoneBarDragging(KeyNr: Integer;
  Shift: TShiftState; X, Y: Integer);
begin
  if Assigned(FOnMoveZoneBarDragging) then
    FOnMoveZoneBarDragging(Self, KeyNr, FMidiZoneBarDragging, Shift, X, Y);
  FMidiZoneBarDragging.LastKey := KeyNr;
end;

procedure TCustomGuiMidiKeys.EndZoneBarDragging(Shift: TShiftState;
  X, Y: Integer);
begin
  if Assigned(FOnEndZoneBarDragging) then
    FOnEndZoneBarDragging(Self, FMidiZoneBarDragging, Shift, X, Y);
  FMidiZoneBarDragging.isDragging := False;
end;
