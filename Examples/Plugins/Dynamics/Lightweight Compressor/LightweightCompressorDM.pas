...
function TLightweightCompressorDataModule.GetLightweightCompressor
  (Index: Integer): TCustomKneeCompressor;
begin
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateAttack;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateRelease;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateThreshold;
end;

procedure TLightweightCompressorDataModule.ParameterRatioChange(Sender: TObject;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateRatio;
end;

procedure TLightweightCompressorDataModule.ParameterKneeChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FCompressor[0]) then
  begin
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateKnee;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateAutoMakeUpGain;
end;

procedure TLightweightCompressorDataModule.ParameterMixChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  Value := 100;
end;

procedure TLightweightCompressorDataModule.ParameterTimeLabel(Sender: TObject;
...
procedure TLightweightCompressorDataModule.ParameterTimeDisplay(Sender: TObject;
  const Index: Integer; var PreDefined: AnsiString);
var
  Val: Single;
begin
...
begin
 if Assigned(FCompressor[0]) then
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateMakeUp;
end;
...
begin
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateStereo;
end;

procedure TLightweightCompressorDataModule.ParameterLimitChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  ChooseProcess;
  ...
  // update GUI
  if EditorForm is TFmLightweightCompressor then
    TFmLightweightCompressor(EditorForm).UpdateLimit;
end;
...
procedure TLightweightCompressorDataModule.VSTModuleProcessStereoSoftClip
...
procedure TLightweightCompressorDataModule.VSTModuleSampleRateChange
