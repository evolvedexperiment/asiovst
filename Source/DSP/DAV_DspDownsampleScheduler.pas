...
type
  TDownsampleProcess32 = function(Sender: TObject; Stage: Integer;
    Input: Single): Single of object;
  ...
  public
    ...
    property MaximumDownsampleStages: Integer read FMaxDSStages
      write FMaxDSStages;
    property OnProcessDownsampled: TDownsampleProcess32
      read FOnProcessDownsampled write FOnProcessDownsampled;
  end;
...
begin
  ...
  begin
    if (FDownSampleCount mod (1 shl Stage)) <> 0 then
      Break;
