...
{$ENDIF}
    ...
    class operator Subtract(const Lhs, Rhs: TFixed8Dot24Point)
      : TFixed8Dot24Point;
...
{$ENDIF}
  ...
  TFixed8Dot24Rect = record
    case Integer of
      0:
        (Left, Top, Right, Bottom: TFixed8Dot24);
      1:
        (TopLeft, BottomRight: TFixed8Dot24Point);
  end;
...
{$ENDIF}
    ...
    class operator Subtract(const Lhs, Rhs: TFixed16Dot16Point)
      : TFixed16Dot16Point;
...
{$ENDIF}
  ...
  TFixed16Dot16Rect = record
    case Integer of
      0:
        (Left, Top, Right, Bottom: TFixed16Dot16);
      1:
        (TopLeft, BottomRight: TFixed16Dot16Point);
  end;
...
{$ENDIF}
    ...
    class operator Subtract(const Lhs, Rhs: TFixed24Dot8Point)
      : TFixed24Dot8Point;
...
{$ENDIF}
  ...
  TFixed24Dot8Rect = record
    case Integer of
      0:
        (Left, Top, Right, Bottom: TFixed24Dot8);
      1:
        (TopLeft, BottomRight: TFixed24Dot8Point);
  end;
...
function Fixed8Dot24Rect(Left, Top, Right, Bottom: TFixed8Dot24)
  : TFixed8Dot24Rect; overload;
function Fixed16Dot16Rect(Left, Top, Right, Bottom: TFixed16Dot16)
  : TFixed16Dot16Rect; overload;
function Fixed24Dot8Rect(Left, Top, Right, Bottom: TFixed24Dot8)
  : TFixed24Dot8Rect; overload;

function Fixed8Dot24Rect(Left, Top, Right, Bottom: Single)
  : TFixed8Dot24Rect; overload;
function Fixed16Dot16Rect(Left, Top, Right, Bottom: Single)
  : TFixed16Dot16Rect; overload;
function Fixed24Dot8Rect(Left, Top, Right, Bottom: Single)
  : TFixed24Dot8Rect; overload;

function Fixed8Dot24Rect(Left, Top, Right, Bottom: Integer)
  : TFixed8Dot24Rect; overload;
function Fixed16Dot16Rect(Left, Top, Right, Bottom: Integer)
  : TFixed16Dot16Rect; overload;
function Fixed24Dot8Rect(Left, Top, Right, Bottom: Integer)
  : TFixed24Dot8Rect; overload;
...
class operator TFixed8Dot24Point.Add(const Lhs, Rhs: TFixed8Dot24Point)
  : TFixed8Dot24Point;
begin
...
class operator TFixed8Dot24Point.Subtract(const Lhs, Rhs: TFixed8Dot24Point)
  : TFixed8Dot24Point;
begin
  Result.X := Lhs.X + Rhs.X;
  Result.Y := Lhs.Y + Rhs.Y;
...
class operator TFixed16Dot16Point.Add(const Lhs, Rhs: TFixed16Dot16Point)
  : TFixed16Dot16Point;
begin
  Result.X := Lhs.X + Rhs.X;
  Result.Y := Lhs.Y + Rhs.Y;
...
class operator TFixed16Dot16Point.Subtract(const Lhs, Rhs: TFixed16Dot16Point)
  : TFixed16Dot16Point;
begin
  Result.X := Lhs.X - Rhs.X;
  Result.Y := Lhs.Y - Rhs.Y;
...
class operator TFixed24Dot8Point.Add(const Lhs, Rhs: TFixed24Dot8Point)
  : TFixed24Dot8Point;
begin
  Result.X := Lhs.X + Rhs.X;
  Result.Y := Lhs.Y + Rhs.Y;
...
class operator TFixed24Dot8Point.Subtract(const Lhs, Rhs: TFixed24Dot8Point)
  : TFixed24Dot8Point;
begin
  Result.X := Lhs.X - Rhs.X;
  Result.Y := Lhs.Y - Rhs.Y;
