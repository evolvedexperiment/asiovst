...
type
  ...
  TDspBaseProcessFuncDA = procedure(var ProcessBuffer: TDAVDoubleDynArray;
    const Channel, SampleFrames: Integer) of object;
  TDspBaseProcessFuncSAA = procedure(var ProcessBuffer: TDAVArrayOfSingleDynArray;
    const SampleFrames: Integer) of object;
  TDspBaseProcessFuncDAA = procedure(var ProcessBuffer: TDAVArrayOfDoubleDynArray;
    const SampleFrames: Integer) of object;
