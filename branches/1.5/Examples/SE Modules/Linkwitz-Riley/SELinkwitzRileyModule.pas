...
procedure TSELinkwitzRileyModule.SubProcessStatic(const BufferOffset,
...
class procedure TSELinkwitzRileyModule.GetModuleProperties
...
function TSELinkwitzRileyModule.GetPinProperties(const Index: Integer;
