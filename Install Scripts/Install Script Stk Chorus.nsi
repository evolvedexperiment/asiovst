...
Section "Stk Chorus VST-Plugin" SecVstPlugins
  SetOutPath "$INSTDIR"
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\UninstallStkChorus.exe"
SectionEnd
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecVstPlugins ${LANG_ENGLISH} "Stk Chorus VST Plugin"
