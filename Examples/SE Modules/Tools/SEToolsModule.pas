...
procedure TSEToolsModule.SubProcessStatic(const BufferOffset,
...
class procedure TSELimitFloatModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited;
  with Properties^ do
...
begin
  ...
  if CurrentPin.PinID in [0 .. 2] then
    FFloatOut := Limit(FFloatIn, FLower, FUpper);
end;

// describe the pins (plugs)
function TSELimitFloatModule.GetPinProperties(const Index: Integer;
...
// describe your module
class procedure TSELimitDoubleModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited;
  with Properties^ do
...
begin
  inherited;
  if CurrentPin.PinID in [0 .. 2] then
    if FDoubleIn < FLower then
      FDoubleOut := FLower
    else if FDoubleIn > FUpper then
      FDoubleOut := FUpper
    else
      FDoubleOut := FDoubleIn;
end;

// describe the pins (plugs)
function TSELimitDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
// describe your module
class procedure TSELimitIntegerModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited;
  with Properties^ do
...
begin
  inherited;
  if CurrentPin.PinID in [0 .. 2] then
    if FIntIn < FLower then
      FIntOut := FLower
    else if FIntIn > FUpper then
      FIntOut := FUpper
    else
      FIntOut := FIntIn;
end;
...
// describe the pins (plugs)
function TSELimitIntegerModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FPowerOf2 := RoundToPowerOf2(FIntIn);
end;
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FPowerOf2 := TruncToPowerOf2(FIntIn);
end;
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FPowerOf2 := ExtendToPowerOf2(FIntIn);
end;
...
function TSESincSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSESincDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSESigmoidSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSESigmoidDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSEFractionalSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSEFractionalDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSEAbsoluteSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSEAbsoluteDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSEModuloSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FFloatOut := FastMod(FFloatIn, FFloatMod);
end;
...
function TSEModuloDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FDoubleOut := FastMod(FDoubleIn, FDoubleMod);
end;
...
function TSEMinimumIntModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSEMinimumSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FFloatOut := min(FFloatInA, FFloatInB);
end;
...
function TSEMinimumDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FDoubleOut := min(FDoubleInA, FDoubleInB);
end;
...
function TSEMaximumIntModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
function TSEMaximumSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FFloatOut := max(FFloatInA, FFloatInB);
end;
...
function TSEMaximumDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    FDoubleOut := max(FDoubleInA, FDoubleInB);
end;
...
function TSEGetSinCosSingleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    GetSinCos(FFloatFrq, FFloatSin, FFloatCos);
end;
...
function TSEGetSinCosDoubleModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := True;
  case Index of
...
begin
  inherited;
  if CurrentPin.PinID = 0 then
    GetSinCos(FDoubleFrq, FDoubleSin, FDoubleCos);
end;
