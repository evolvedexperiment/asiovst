...
begin
 ...
 begin
  ...
  begin
   ...
   info.Lines.add('samplerate 8000 Hz possible: ' + booltostr(b, true));
   b := cansamplerate(16000) = ASE_OK;
   info.Lines.add('samplerate 16000 Hz possible: ' + booltostr(b, true));
   b := cansamplerate(22050) = ASE_OK;
   info.Lines.add('samplerate 22050 Hz possible: ' + booltostr(b, true));
   b := cansamplerate(32000) = ASE_OK;
   info.Lines.add('samplerate 32000 Hz possible: ' + booltostr(b, true));
   b := cansamplerate(44100) = ASE_OK;
   info.Lines.add('samplerate 44100 Hz possible: ' + booltostr(b, true));
   b := cansamplerate(48000) = ASE_OK;
   info.Lines.add('samplerate 48000 Hz possible: ' + booltostr(b, true));
   b := cansamplerate(96000) = ASE_OK;
   info.Lines.add('samplerate 96000 Hz possible: ' + booltostr(b, true));
   b := cansamplerate(192000) = ASE_OK;
   info.Lines.add('samplerate 192000 Hz possible: ' + booltostr(b, true));
   info.Lines.add('');
  end;
  DriverIndex := o;
  Host.StartAudio;
