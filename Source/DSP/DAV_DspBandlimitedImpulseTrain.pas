...
type
  ...
  TCustomSimpleBandlimitedImpulseTrain32 = class
  ...
  TSimpleBandlimitedImpulseTrain32 = class
    (TCustomSimpleBandlimitedImpulseTrain32, IDspGenerator32)
  private
    FLastSample: Single;
  public
  ...
  TSimpleBandlimitedBipolarImpulseTrain32 = class
    (TCustomSimpleBandlimitedImpulseTrain32, IDspGenerator32)
  private
    FLastSample: Single;
  public
  ...
  TSynchronizedImpulseTrain32 = class(TDspSampleRatePersistent, IDspGenerator32)
  private
    FFrequency: Single;
    procedure SetFrequency(const Value: Single);
  protected
...
procedure TCustomSimpleBandlimitedImpulseTrain.SetBufferSize
  (const Value: Integer);
begin
...
procedure TCustomSimpleBandlimitedImpulseTrain.SetFrequency
  (const Value: Single);
begin
...
procedure TCustomSimpleBandlimitedImpulseTrain32.SetFractional
  (const Value: Single);
begin
...
begin
  for SampleIndex := 0 to SampleCount - 1 do
    Data[SampleIndex] := ProcessSample32;
end;
