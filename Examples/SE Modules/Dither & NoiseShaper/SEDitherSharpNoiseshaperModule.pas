...
type
  ...
  TSEDitherSharpNoiseshaperStaticModule = class
  ...
  TSEDitherSharpNoiseshaperControllableModule = class
...
constructor TCustomSEDitherSharpNoiseshaperModule.Create(SEAudioMaster
...
procedure TCustomSEDitherSharpNoiseshaperModule.SubProcessStatic
...
class procedure TCustomSEDitherSharpNoiseshaperModule.GetModuleProperties
...
function TCustomSEDitherSharpNoiseshaperModule.GetPinProperties
...
procedure TCustomSEDitherSharpNoiseshaperModule.PlugStateChange
...
procedure TSEDitherSharpNoiseshaperStaticModule.SubProcess(const BufferOffset,
...
// describe the pins (plugs)
function TSEDitherSharpNoiseshaperStaticModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
...
// An input plug has changed value
procedure TSEDitherSharpNoiseshaperStaticModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  inherited;
  case TSEDitherNoiseshaperPins(CurrentPin.PinID) of
...
function TSEDitherSharpNoiseshaperControllableModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
