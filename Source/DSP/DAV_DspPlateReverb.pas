...
type
  ...
  protected
    ...
    FResampleFilters    : array [0..2] of TButterworthLP;
...
begin
 ...
 FResampleFilters[0] := TButterworthLP.Create(2);
 FResampleFilters[1] := TButterworthLP.Create(1);
 FResampleFilters[2] := TButterworthLP.Create(1);
// FPreDelay := TDelayLineSamples32.Create(12);
 ...
 FSampleRate := 44100;
 SampleRateChanged;
 FLowpass[0] := TButterworthLP.Create(1);
 FLowpass[0].Frequency := 13.400;
 FLowpass[1] := TButterworthLP.Create(1);
 FLowpass[1].Frequency := 13.400;
 FHighpass[0] := TButterworthHP.Create(1);
 FHighpass[0].Frequency := 13.4;
 FHighpass[1] := TButterworthHP.Create(1);
