...
type
  ...
  TSEMp3PlayerPins = (pinFileName, pinBufferSize, pinReset, pinOutputLeft,
    pinOutputRight);
...
procedure TSESimpleMp3PlayerModule.PlugStateChange(const CurrentPin: TSEPin);
begin
  inherited;
...
procedure TSESimpleMp3PlayerModule.SubProcess(const BufferOffset,
...
procedure TSESimpleMp3PlayerModule.SubProcessBypass(const BufferOffset,
  SampleFrames: Integer);
begin
...
class procedure TSESimpleMp3PlayerModule.GetModuleProperties
...
function TSESimpleMp3PlayerModule.GetPinProperties(const Index: Integer;
