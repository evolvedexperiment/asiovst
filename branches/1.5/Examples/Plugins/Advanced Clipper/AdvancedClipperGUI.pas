...
begin
  ...
  begin
    ClipLEDInput.Brightness_Percent := Power(Limit(PeakInput - 1, 0, 1),
      0.01) * 100;
    ClipLEDStage1.Brightness_Percent := Power(Limit(PeakStage1 - 1, 0, 1),
      0.01) * 100;
    ClipLEDStage2.Brightness_Percent := Power(Limit(PeakStage2 - 1, 0, 1),
      0.01) * 100;
  end;
end;
...
begin
  ...
  begin
    ...
    if DialInputGain.Value <> Value then
      DialInputGain.Value := Value;
    LbDisplay.Caption := 'Input Gain: ' + FloatToStrF(Value, ffGeneral, 2,
      2) + 'dB';
  end;
end;
...
begin
  ...
  begin
    ...
    if DialFilterOrder1.Value <> Value then
      DialFilterOrder1.Value := Value;
...
begin
  ...
  begin
    ...
    if DialFilterOrder2.Value <> Value then
      DialFilterOrder2.Value := Value;
    LbDisplay.Caption := 'Filter Order: ' + IntToStr(Round(Value));
  end;
end;
...
begin
  ...
  begin
    ...
    if DialOSFactor1.Value <> Value then
      DialOSFactor1.Value := Value;
...
begin
  ...
  begin
    ...
    if DialOSFactor2.Value <> Value then
      DialOSFactor2.Value := Value;
    LbDisplay.Caption := 'Oversampling: ' + IntToStr(Round(Value)) + 'x';
  end;
end;
...
begin
  ...
  begin
    ...
    if DialOutputGain.Value <> Value then
      DialOutputGain.Value := Value;
    LbDisplay.Caption := 'Output Gain: ' + FloatToStrF(Value, ffGeneral, 2,
      2) + 'dB';
  end;
end;
