...
RegisterDspProcessors32([TAutomatableGainFilter, TAutomatablePeakFilter,
  TAutomatableAllpassFilter, TAutomatableLowShelfFilter,
  TAutomatableLowShelfAFilter, TAutomatableLowShelfBFilter,
  TAutomatableHighShelfAFilter, TAutomatableHighShelfBFilter,
  TAutomatableHighcutFilter, TAutomatableLowcutFilter,
  TAutomatableBandpassFilter, TAutomatableNotchFilter]);
