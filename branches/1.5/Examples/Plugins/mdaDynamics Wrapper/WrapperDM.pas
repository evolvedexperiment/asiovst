...
function TWrapperDataModule.VSTModuleCanDo(Sender: TObject;
  const CanDoText: AnsiString): Integer;
begin
...
procedure TWrapperDataModule.VSTModuleBlockSizeChange(Sender: TObject;
...
procedure TWrapperDataModule.VSTModuleProcess(const Inputs,
  Outputs: TDAVArrayOfSingleFixedArray; const SampleFrames: Cardinal);
begin
  VstHost[0].Process(@Inputs[0], @Outputs[0], SampleFrames);
end;

procedure TWrapperDataModule.VSTModuleProcessReplacing(const Inputs,
  Outputs: TDAVArrayOfSingleFixedArray; const SampleFrames: Cardinal);
begin
