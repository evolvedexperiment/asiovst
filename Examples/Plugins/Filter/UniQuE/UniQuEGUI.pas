...
begin
  with TUniQuEDataModule(Owner) do
  begin
    if DialHigh.Value <> Parameter[6] then
      DialHigh.Value := Parameter[6];
  end;
end;
...
begin
  with TUniQuEDataModule(Owner) do
  begin
    if DialLow.Value <> Parameter[3] then
      DialLow.Value := Parameter[3];
  end;
end;
...
begin
  with TUniQuEDataModule(Owner) do
  begin
    if DialMid.Value <> Parameter[4] then
      DialMid.Value := Parameter[4];
  end;
end;
...
begin
  with TUniQuEDataModule(Owner) do
  begin
    if DialPresence.Value <> Parameter[5] then
      DialPresence.Value := Parameter[5];
  end;
end;
