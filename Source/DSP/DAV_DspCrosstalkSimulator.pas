...
type
  ...
  public
    procedure ProcessSample(var Left, Right: Single); overload;
      virtual; abstract;
    procedure ProcessSample(var Left, Right: Double); overload;
      virtual; abstract;
  end;
...
procedure TCustomIIRCrosstalkSimulator.SetModel(const Value
  : TIIRCrosstalkSimulatorModel);
begin
...
begin
  ...
  FBuffer[0, FBufPos] := FMulFactor[1] * FFilter[0, 2].ProcessSample64
    (FFilter[0, 1].ProcessSample64(FFilter[0, 0].ProcessSample64(ip[1])));
  FBuffer[1, FBufPos] := FMulFactor[1] * FFilter[1, 2].ProcessSample64
    (FFilter[1, 1].ProcessSample64(FFilter[1, 0].ProcessSample64(ip[0])));
end;
