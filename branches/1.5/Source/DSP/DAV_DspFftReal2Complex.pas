...
type
  ...
  TPerform32PackedReIm = procedure(const FrequencyDomain,
    TimeDomain: PDAVSingleFixedArray) of object;
  TPerform64PackedReIm = procedure(const FrequencyDomain,
    TimeDomain: PDAVDoubleFixedArray) of object;
  TPerform32PackedComplex = procedure(const FreqDomain
    : PDAVComplexSingleFixedArray; const TimeDomain: PDAVSingleFixedArray)
    of object;
  TPerform64PackedComplex = procedure(const FreqDomain
    : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray)
    of object;
  ...
  protected
    ...
    procedure PerformFFTZero32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTZero32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTOne32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTOne32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTTwo32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTTwo32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTThree32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTThree32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTFour32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTFour32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTOdd32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTOdd32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTEven32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformFFTEven32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTZero32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTZero32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTOne32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTOne32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTTwo32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTTwo32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTThree32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTThree32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTFour32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTFour32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTOdd32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTOdd32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTEven32(const FreqDomain,
      TimeDomain: PDAVSingleFixedArray); overload;
    procedure PerformIFFTEven32(const FreqDomain: PDAVComplexSingleFixedArray;
      const TimeDomain: PDAVSingleFixedArray); overload;
  ...
  protected
    ...
    procedure AssignTo(Dest: TPersistent); override;
    procedure CalculateTrigoLUT; override;
    procedure PerformFFTZero64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTZero64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTOne64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTOne64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTTwo64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTTwo64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTThree64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTThree64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTFour64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTFour64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTOdd64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTOdd64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTEven64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformFFTEven64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTZero64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTZero64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTOne64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTOne64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTTwo64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTTwo64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTThree64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTThree64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTOdd64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTOdd64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTEven64(const FreqDomain,
      TimeDomain: PDAVDoubleFixedArray); overload;
    procedure PerformIFFTEven64(const FreqDomain: PDAVComplexDoubleFixedArray;
      const TimeDomain: PDAVDoubleFixedArray); overload;
    procedure SetFFTFunctionPointers; override;
  public
    constructor Create; override;
  ...
  published
    property Order;
    property OnSizeChanged;
    property PerformFFTPackedComplex: TPerform64PackedComplex
      read FPerformFFTPackedComplex;
    property PerformIFFTPackedComplex: TPerform64PackedComplex
      read FPerformIFFTPackedComplex;
    property PerformFFTPackedReIm: TPerform64PackedReIm
      read FPerformFFTPackedReIm;
    property PerformIFFTPackedReIm: TPerform64PackedReIm
      read FPerformIFFTPackedReIm;
  end;
...
begin
  for SampleIndex := 0 to FFftSize - 1 do
    PDAVDoubleFixedArray(Doubles)^[SampleIndex] := PDAVSingleFixedArray(Singles)
      ^[SampleIndex];
{$ELSE}
asm
  PUSH    EBX
...
begin
  for SampleIndex := 0 to FFftSize - 1 do
    PDAVSingleFixedArray(Singles)^[SampleIndex] := PDAVDoubleFixedArray(Doubles)
      ^[SampleIndex];
{$ELSE}
asm
  PUSH    EBX
...
begin
  ...
  else if Dest is TFftReal2ComplexNativeFloat64 then
    with TFftReal2ComplexNativeFloat64(Dest) do
    begin
      inherited;
      Assert(FFftSize = Self.FFftSize);
      for Sample := 0 to FFTSize - 1 do
        FBuffer^[Sample] := Self.FBuffer^[Sample];
      SetFFTFunctionPointers;
    end
  else
    inherited;
...
procedure TFftReal2ComplexNativeFloat32.Rescale
  (const Data: PDAVSingleFixedArray);
var
  i: Integer;
  s: Double;
begin
...
procedure TFftReal2ComplexNativeFloat32.PerformFFTThree32(const FreqDomain,
  TimeDomain: PDAVSingleFixedArray);
var
...
procedure TFftReal2ComplexNativeFloat32.PerformFFTFour32(const FreqDomain
  : PDAVComplexSingleFixedArray; const TimeDomain: PDAVSingleFixedArray);
var
  ci, i: Integer;
  NbrCoef: Integer;
...
procedure TFftReal2ComplexNativeFloat32.PerformIFFTThree32(const FreqDomain,
  TimeDomain: PDAVSingleFixedArray);
var
  FD: PDAV8SingleArray absolute FreqDomain;
  TD: PDAV8SingleArray absolute TimeDomain;
...
procedure TFftReal2ComplexNativeFloat32.PerformIFFTFour32(const FreqDomain,
  TimeDomain: PDAVSingleFixedArray);
var
  NbrCoef: Integer;
  NbrCoefH: Integer;
...
begin
  ...
  begin
    ...
    TimeDomain[ci + NbrCoefH] := FreqDomain[NbrCoef + ci] - FreqDomain
      [NbrCoefD - ci];
...
procedure TFftReal2ComplexNativeFloat64.Rescale
  (const Data: PDAVDoubleFixedArray);
var
  i: Integer;
  s: Double;
begin
...
procedure TFftReal2ComplexNativeFloat64.RescaleSqrt
  (const Data: PDAVDoubleFixedArray);
var
  i: Integer;
  s: Double;
...
procedure TFftReal2ComplexNativeFloat64.PerformFFT(const FrequencyDomain,
  TimeDomain: Pointer);
begin
  case DataOrder of
    doPackedRealImaginary:
...
procedure TFftReal2ComplexNativeFloat64.PerformIFFT(const FrequencyDomain,
  TimeDomain: Pointer);
begin
  case DataOrder of
    doPackedRealImaginary:
...
procedure TFftReal2ComplexNativeFloat64.PerformFFTZero64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
{$IFDEF PUREPASCAL}
begin
  FreqDomain[0].Re := TimeDomain[0];
...
procedure TFftReal2ComplexNativeFloat64.PerformFFTOne64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
{$IFDEF PUREPASCAL}
var
...
procedure TFftReal2ComplexNativeFloat64.PerformFFTTwo64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
{$IFDEF PUREPASCAL}
var
  tmp: array [0 .. 1] of Double;
...
procedure TFftReal2ComplexNativeFloat64.PerformFFTThree64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
var
...
procedure TFftReal2ComplexNativeFloat64.PerformFFTFour64(const FreqDomain,
  TimeDomain: PDAVDoubleFixedArray);
var
  ci: Integer;
  NbrCoef: Integer;
...
procedure TFftReal2ComplexNativeFloat64.PerformFFTOdd64(const FreqDomain,
  TimeDomain: PDAVDoubleFixedArray);
var
  Pass, ci, i: Integer;
  NbrCoef: Integer;
...
procedure TFftReal2ComplexNativeFloat64.PerformFFTEven64(const FreqDomain,
  TimeDomain: PDAVDoubleFixedArray);
var
  Pass, ci, i: Integer;
  NbrCoef: Integer;
...
procedure TFftReal2ComplexNativeFloat64.PerformIFFTZero64(const FreqDomain,
  TimeDomain: PDAVDoubleFixedArray);
{$IFDEF PUREPASCAL}
begin
  TimeDomain^[0] := FreqDomain^[0];
...
procedure TFftReal2ComplexNativeFloat64.PerformIFFTOne64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
{$IFDEF PUREPASCAL}
var
  FD: PComplex64 absolute FreqDomain;
...
procedure TFftReal2ComplexNativeFloat64.PerformIFFTTwo64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
{$IFDEF PUREPASCAL}
var
  tmp: array [0 .. 1] of Double;
...
procedure TFftReal2ComplexNativeFloat64.PerformIFFTThree64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
var
  FD: PDAV4ComplexDoubleArray absolute FreqDomain;
  TD: PDAV8DoubleArray absolute TimeDomain;
...
procedure TFftReal2ComplexNativeFloat64.PerformIFFTEven64(const FreqDomain,
  TimeDomain: PDAVDoubleFixedArray);
var
  Pass: Integer;
  NbrCoef: Integer;
...
procedure TFftReal2ComplexNativeFloat64.PerformIFFTOdd64(const FreqDomain
  : PDAVComplexDoubleFixedArray; const TimeDomain: PDAVDoubleFixedArray);
var
  Pass: Integer;
  NbrCoef: Integer;
