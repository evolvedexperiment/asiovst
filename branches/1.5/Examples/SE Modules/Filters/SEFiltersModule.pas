...
constructor TCustomSEFiltersModule.Create(SEAudioMaster
...
procedure TCustomSEFiltersModule.SubProcess(const BufferOffset,
...
class procedure TCustomSEFiltersModule.GetModuleProperties
...
function TCustomSEFiltersModule.GetPinProperties(const Index: Integer;
...
constructor TSEBasicLowpassModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
class procedure TSEBasicLowpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
...
constructor TSEBasicHighpassModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
class procedure TSEBasicHighpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
constructor TSEBasicBandpassModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
class procedure TSEBasicBandpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
constructor TSEBasicNotchModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
class procedure TSEBasicNotchModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
constructor TSEBasicLowshelfModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
class procedure TSEBasicLowshelfModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
constructor TSEBasicLowshelfAModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
constructor TSEBasicLowshelfBModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
constructor TSEBasicHighshelfModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
class procedure TSEBasicHighshelfModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
constructor TSEBasicHighshelfAModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
constructor TSEBasicHighshelfBModule.Create(SEAudioMaster
  : TSE2audioMasterCallback; Reserved: Pointer);
begin
...
constructor TSEBasicPeakModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
class procedure TSEBasicPeakModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
constructor TSEBasicAllpassModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
class procedure TSEBasicAllpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
constructor TSEBasicShapeModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
class procedure TSEBasicShapeModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
begin
  ...
  for Plug := 0 to DynamicPlugCount - 1 do
    try
      FFilterRefs[Plug] := Pointer(CallHost(SEAudioMasterGetPinVarAddress,
        3 + Plug));
      if FFilterRefs[Plug] <> nil then
        FFilterCascade.AddFilter(TCustomFilter(FFilterRefs[Plug]^));
    except
    end;
...
class procedure TFilterCascadeModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited;
