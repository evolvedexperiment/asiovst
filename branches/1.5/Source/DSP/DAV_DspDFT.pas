...
procedure DFT(realTime, imagTime, realFreq,
  imagFreq: TDAVSingleDynArray); overload;
procedure DFT(realTime, imagTime, realFreq,
  imagFreq: TDAVDoubleDynArray); overload;
procedure InverseDFT(realTime, imagTime, realFreq,
  imagFreq: TDAVSingleDynArray); overload;
procedure InverseDFT(realTime, imagTime, realFreq,
  imagFreq: TDAVDoubleDynArray); overload;
...
function Goertzel(TimeSignal: TDAVSingleDynArray; const NormFrequency: Double)
  : TComplex32; overload;
function Goertzel(TimeSignal: TDAVDoubleDynArray; const NormFrequency: Double)
  : TComplex64; overload;
function Goertzel(TimeSignal: PDAVSingleFixedArray; const Length: Integer;
  const NormFrequency: Double): TComplex32; overload;
function Goertzel(TimeSignal: PDAVDoubleFixedArray; const Length: Integer;
  const NormFrequency: Double): TComplex64; overload;

function Goertzel(TimeSignal: TDAVSingleDynArray; const Angular: TComplex32)
  : TComplex32; overload;
function Goertzel(TimeSignal: TDAVDoubleDynArray; const Angular: TComplex64)
  : TComplex64; overload;
function Goertzel(TimeSignal: PDAVSingleFixedArray; const Length: Integer;
  const Angular: TComplex32): TComplex32; overload;
function Goertzel(TimeSignal: PDAVDoubleFixedArray; const Length: Integer;
  const Angular: TComplex64): TComplex64; overload;
