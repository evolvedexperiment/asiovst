...
procedure TBugpassLiteDataModule.ParamFreqLowChange(Sender: TObject;
...
procedure TBugpassLiteDataModule.ParamFreqHighChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  CalculateFilterKernel;
  ...
  try
    ...
    begin
      case FFft.DataOrder of
        doPackedRealImaginary:
          begin
            FFft.PerformFFTPackedReIm(PDAVSingleFixedArray(FSignalFreq),
              @Inputs[Channel, 0]);
            ...
            while Bin < Half do
            begin
              ComplexMultiplyInplace32(PDAVSingleFixedArray(FSignalFreq)^[Bin],
            ...
            FFft.PerformIFFTPackedReIm(PDAVSingleFixedArray(FSignalFreq),
              @Outputs[Channel, 0]);
          end;
        doPackedComplex:
          begin
