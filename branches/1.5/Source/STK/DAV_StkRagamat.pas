...
const
  ragaUp: array [0 .. 1, 0 .. 11] of Integer = ((57, 60, 62, 64, 65, 68, 69, 71,
    72, 76, 77, 81), (52, 54, 55, 57, 59, 60, 63, 64, 66, 67, 71, 72));
  ragaDown: array [0 .. 1, 0 .. 11] of Integer = ((57, 60, 62, 64, 65, 67, 69,
    71, 72, 76, 79, 81), (48, 52, 53, 55, 57, 59, 60, 64, 66, 68, 70, 72));
...
begin
  ...
  begin
    ...
    begin
      ...
      if (FRagaPoint < 0) then
        FRagaPoint := FRagaPoint - (2 * FRagaStep);
