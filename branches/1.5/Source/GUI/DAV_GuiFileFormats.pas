...
type
  ...
  protected
    ...
    class function CanLoad(Stream: TStream): Boolean; overload;
      virtual; abstract;
    class function CanHandleExtension(const FileName: TFileName): Boolean;
      virtual; abstract;
  public
...
begin
  ...
  GGraphicFileFormatClasses[Length(GGraphicFileFormatClasses) - 1] :=
    FileFormatClass;
end;
...
var
  FileFormatClassIndex: Integer;
begin
  for FileFormatClassIndex := 0 to Length(FileFormatClasses) - 1 do
    RegisterGraphicFileFormat(FileFormatClasses[FileFormatClassIndex]);
end;
