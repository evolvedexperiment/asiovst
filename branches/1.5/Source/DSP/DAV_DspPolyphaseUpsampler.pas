...
type
  TProcessSample32 = procedure(const Input: Single;
    out Output: TDAV2SingleArray) of object;
  TProcessSample64 = procedure(const Input: Double;
    out Output: TDAV2DoubleArray) of object;
  ...
  private
    ...
    procedure ProcessSampleOdd(const Input: Single;
      out Output: TDAV2SingleArray);
    procedure ProcessSampleEven(const Input: Single;
      out Output: TDAV2SingleArray);
  protected
  ...
  private
    ...
    procedure ProcessSampleOdd(const Input: Double;
      out Output: TDAV2DoubleArray);
    procedure ProcessSampleEven(const Input: Double;
      out Output: TDAV2DoubleArray);
  protected
    procedure AssignTo(Dest: TPersistent); override;
...
constructor TCustomPolyphaseUpsampler.Create(const NumberOfCoefficients
...
begin
  ...
  else if Dest is TPolyphaseUpsampler64 then
...
begin
  case FNumberOfCoeffs of
    ...
    if FNumberOfCoeffs mod 2 <> 0 then
      FProcessSample32 := ProcessSampleOdd
    else
      FProcessSample32 := ProcessSampleEven;
  end;
end;
...
procedure TPolyphaseUpsampler32.ProcessBlock(const Input,
  Output: PDAVSingleFixedArray; const SampleFrames: Integer);
var
  Pos: Integer;
begin
  for Pos := 0 to SampleFrames - 1 do
    FProcessSample32(Input[Pos], PDAV2SingleArray(@Output[Pos * 2])^);
end;

procedure TPolyphaseUpsampler32.ProcessSample1(const Input: Single;
  out Output: TDAV2SingleArray);
{$IFDEF PUREPASCAL}
begin
...
procedure TPolyphaseUpsampler32.ProcessSample2(const Input: Single;
  out Output: TDAV2SingleArray);
{$IFDEF PUREPASCAL}
var
...
procedure TPolyphaseUpsampler32.ProcessSample3(const Input: Single;
  out Output: TDAV2SingleArray);
{$IFDEF PUREPASCAL}
var
...
procedure TPolyphaseUpsampler32.ProcessSample4(const Input: Single;
  out Output: TDAV2SingleArray);
{$IFDEF PUREPASCAL}
var
...
procedure TPolyphaseUpsampler32.ProcessSampleOdd(const Input: Single;
  out Output: TDAV2SingleArray);
{$IFDEF PUREPASCAL}
var
  Index: Integer;
...
procedure TPolyphaseUpsampler32.ProcessSampleEven(const Input: Single;
  out Output: TDAV2SingleArray);
{$IFDEF PUREPASCAL}
var
  Index: Integer;
...
begin
  ...
  else if Dest is TPolyphaseUpsampler32 then
    with TPolyphaseUpsampler32(Dest) do
    begin
      inherited;
      Assert(FNumberOfCoeffs = Self.FNumberOfCoeffs);
...
begin
  case FNumberOfCoeffs of
    ...
    if FNumberOfCoeffs mod 2 <> 0 then
      FProcessSample64 := ProcessSampleOdd
    else
      FProcessSample64 := ProcessSampleEven;
  end;
end;
...
procedure TPolyphaseUpsampler64.ProcessBlock(const Input,
  Output: PDAVDoubleFixedArray; const SampleFrames: Integer);
var
  Pos: Integer;
begin
  for Pos := 0 to SampleFrames - 1 do
    FProcessSample64(Input[Pos], PDAV2DoubleArray(@Output[Pos * 2])^);
end;

procedure TPolyphaseUpsampler64.ProcessSample1(const Input: Double;
  out Output: TDAV2DoubleArray);
{$IFDEF PUREPASCAL}
begin
  FY[0] := (Input - FY[0]) * FCoefficients[0] + FX[0];
...
procedure TPolyphaseUpsampler64.ProcessSample2(const Input: Double;
  out Output: TDAV2DoubleArray);
{$IFDEF PUREPASCAL}
var
...
procedure TPolyphaseUpsampler64.ProcessSample3(const Input: Double;
  out Output: TDAV2DoubleArray);
{$IFDEF PUREPASCAL}
var
...
procedure TPolyphaseUpsampler64.ProcessSample4(const Input: Double;
  out Output: TDAV2DoubleArray);
{$IFDEF PUREPASCAL}
var
...
procedure TPolyphaseUpsampler64.ProcessSampleOdd(const Input: Double;
  out Output: TDAV2DoubleArray);
{$IFDEF PUREPASCAL}
var
  Index: Integer;
...
procedure TPolyphaseUpsampler64.ProcessSampleEven(const Input: Double;
  out Output: TDAV2DoubleArray);
{$IFDEF PUREPASCAL}
var
  Index: Integer;
