...
type
  TCustomLightweightDynamicsSEModuleClass = class of
  ...
  TLightweightLimiterParamStaticSEModule = class
  ...
  TCustomLightweightCompressorSEModule = class
    (TCustomLightweightDynamicsSEModule)
  protected
  ...
  TLightweightCompressorStaticSEModule = class
  ...
  TLightweightCompressorParamStaticSEModule = class
  ...
  TCustomLightweightFeedbackCompressorSEModule = class
    (TCustomLightweightCompressorSEModule)
  protected
    FDynamicProcesor: TLightweightSoftKneeFeedbackCompressor;
    FAutoMakeUp: Boolean;
  ...
  TLightweightFeedbackCompressorStaticSEModule = class
    (TCustomLightweightCompressorSEModule)
  protected
    FThreshold: Single;
    FAttack: Single;
  ...
  TLightweightFeedbackCompressorParamStaticSEModule = class
...
procedure TCustomLightweightDynamicsSEModule.PlugStateChange
...
class procedure TCustomLightweightDynamicsSEModule.GetModuleProperties
...
procedure TCustomLightweightDynamicsSEModule.SubProcessStatic
...
begin
  if (Pin[0].Status = stRun) and
    ((Pin[1].Status = stRun) or (Pin[2].Status = stRun)) then
...
function TCustomLightweightDynamicsSEModule.GetPinProperties
...
begin
  ...
  case CurrentPin.PinID of
    ...
    8:
      FDynamicProcesor.Attack := FRelease;
    9:
      FDynamicProcesor.Release := FAttack;
  end;
  inherited;
end;
...
procedure TLightweightGateAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered LightweightDynamics parameter?
  case CurrentPin.PinID of
    5 .. 9:
      if (Pin[5].Status <> stRun) and (Pin[6].Status <> stRun) and
        (Pin[7].Status <> stRun) and (Pin[8].Status <> stRun) and
        (Pin[9].Status <> stRun) then
        OnProcess := SubProcess
      else
...
procedure TLightweightGateAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  SideChain: PDAVSingleFixedArray;
  Input: array [0 .. 1] of PDAVSingleFixedArray;
...
function TLightweightLimiterStaticSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
function TLightweightLimiterParamStaticSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TLightweightLimiterAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  case CurrentPin.PinID of
    5, 7 .. 9:
      if (Pin[5].Status <> stRun) and (Pin[7].Status <> stRun) and
        (Pin[8].Status <> stRun) and (Pin[9].Status <> stRun) then
        OnProcess := SubProcess
      else
        OnProcess := SubProcessAutomated;
    6:
...
procedure TLightweightLimiterAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  SideChain: PDAVSingleFixedArray;
  Input: array [0 .. 1] of PDAVSingleFixedArray;
...
function TCustomLightweightCompressorSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TCustomLightweightCompressorSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered LightweightDynamics parameter?
  case CurrentPin.PinID of
...
function TLightweightCompressorStaticSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TLightweightCompressorAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  case CurrentPin.PinID of
    5 .. 10:
      if (Pin[5].Status <> stRun) and (Pin[6].Status <> stRun) and
        (Pin[7].Status <> stRun) and (Pin[8].Status <> stRun) and
        (Pin[9].Status <> stRun) and (Pin[10].Status <> stRun) then
        OnProcess := SubProcess
      else
        OnProcess := SubProcessAutomated;
  end;
...
procedure TLightweightCompressorAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  SideChain: PDAVSingleFixedArray;
  Input: array [0 .. 1] of PDAVSingleFixedArray;
...
function TCustomLightweightFeedbackCompressorSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TCustomLightweightFeedbackCompressorSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered LightweightDynamics parameter?
  case CurrentPin.PinID of
...
procedure TCustomLightweightFeedbackCompressorSEModule.SubProcess
  (const BufferOffset, SampleFrames: Integer);
var
  SideChain: PDAVSingleFixedArray;
  Input: array [0 .. 1] of PDAVSingleFixedArray;
...
constructor TLightweightFeedbackCompressorStaticSEModule.Create
  (SEAudioMaster: TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
function TLightweightFeedbackCompressorStaticSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TLightweightFeedbackCompressorStaticSEModule.SubProcess
  (const BufferOffset, SampleFrames: Integer);
var
  SideChain: PDAVSingleFixedArray;
  Input: array [0 .. 1] of PDAVSingleFixedArray;
...
class procedure TLightweightFeedbackCompressorParamStaticSEModule.
...
class procedure TLightweightFeedbackCompressorAutomatableSEModule.
  GetModuleProperties(Properties: PSEModuleProperties);
begin
  inherited;
  with Properties^ do
...
procedure TLightweightFeedbackCompressorAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  case CurrentPin.PinID of
    5 .. 10:
...
procedure TLightweightFeedbackCompressorAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  SideChain: PDAVSingleFixedArray;
  Input: array [0 .. 1] of PDAVSingleFixedArray;
