...
begin
  with TAdhesiveDataModule(Owner).FastCompressor, VUMeter do
    GlyphIndex := Round(GlyphCount * Limit(-GainReductiondB, 0, 40) / 40);
end;
...
begin
  ...
  begin
    ...
    if SidechainFilter <> DialFilter.Value then
      DialFilter.Value := SidechainFilter;
  end;
end;
