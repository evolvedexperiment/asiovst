...
constructor TSEResurrectionBassModule.Create(SEAudioMaster
...
procedure TSEResurrectionBassModule.SubProcess(const BufferOffset,
...
procedure TSEResurrectionBassModule.SubProcessStatic(const BufferOffset,
  SampleFrames: Integer);
begin
...
class procedure TSEResurrectionBassModule.GetModuleProperties
...
function TSEResurrectionBassModule.GetPinProperties(const Index: Integer;
...
begin
  ...
  case TSEResurrectionPins(CurrentPin.PinID) of
    ...
    pinAddOriginalBass:
      FBassEnhancer.AddOriginalBass := FAddOriginalBass;
  end;
end;
