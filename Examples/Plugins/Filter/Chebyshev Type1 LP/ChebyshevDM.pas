...
procedure TChebyshevLPModule.StringToFrequency(Sender: TObject;
...
procedure TChebyshevLPModule.StringToOrder(Sender: TObject;
  const Index: Integer; const ParameterString: AnsiString; var Value: Single);
var
  Str: AnsiString;
  Indxes: array [0 .. 1] of Integer;
...
procedure TChebyshevLPModule.ParamOrderDisplay(Sender: TObject;
