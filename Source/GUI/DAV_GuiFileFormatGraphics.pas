...
class function TGuiFileFormatGraphics.CanHandleExtension(const FileName
  : TFileName): Boolean;
begin
...
class function TGuiFileFormatGraphics.CanLoad(const FileName
  : TFileName): Boolean;
var
...
begin
  ...
  else if Source is TGuiCustomPixelMap then
...
begin
  ...
  else if Dest is TGuiCustomPixelMap then
