...
constructor TSERealverbModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
procedure TSERealverbModule.SubProcessStatic(const BufferOffset,
...
procedure TSERealverbModule.SubProcess(const BufferOffset,
  SampleFrames: Integer);
begin
  // lock processing
...
class procedure TSERealverbModule.GetModuleProperties
...
function TSERealverbModule.GetPinProperties(const Index: Integer;
