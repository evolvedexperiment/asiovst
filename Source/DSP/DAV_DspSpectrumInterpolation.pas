...
function QuadraticPeakPosition(const Data: TDAV3DoubleArray): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function BarycentricPeakPosition(const Data: TDAV3SingleArray): Single; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function BarycentricPeakPosition(const Data: TDAV3DoubleArray): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator1(const Prev, Peak, Next: TComplex32): Single; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator1(const Prev, Peak, Next: TComplex64): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator1(const Data: PDAV3ComplexSingleArray): Single; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator1(const Data: PDAV3ComplexDoubleArray): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator2(const Prev, Peak, Next: TComplex32): Single; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator2(const Prev, Peak, Next: TComplex64): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator2(const Data: PDAV3ComplexSingleArray): Single; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function QuinnEstimator2(const Data: PDAV3ComplexDoubleArray): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function JainEstimator(const Prev, Peak, Next: Single): Single; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function JainEstimator(const Prev, Peak, Next: Double): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function JainEstimator(const Data: TDAV3SingleArray): Single; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
function JainEstimator(const Data: TDAV3DoubleArray): Double; overload;
  {$IFDEF useinlining} inline; {$ENDIF}
...
begin
  ...
  ap := (Data^[2].Re * Data^[1].Re + Data^[2].Im * Data^[1].Im) *
    InvPeakMagnitude;
  dp := -ap / (1 - ap);
  am := (Data^[0].Re * Data^[1].Re + Data^[0].Im * Data^[1].Im) *
    InvPeakMagnitude;
  dm := am / (1 - am);
  if (dp > 0) and (dm > 0) then
    Result := dp
...
begin
  Result := Sqr(0.25 * Log10(3 * Sqr(x) + 6 * x + 1) - CSqrt6Div24 *
    Log10((x + 1 - CSqrt2Div3) / (x + 1 + CSqrt2Div3)));
end;
