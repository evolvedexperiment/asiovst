  ...
  with VstHost[0] do
    ...
    begin
      ...
      if (rct.Right - rct.Left > 0) and (rct.Bottom - rct.Top > 0) then
        GrabKnob(Prs, rct, PNm + IntToStr(Prs) + '.png');
    end;
end;
    ...
    with VstHost[0] do
      ...
      begin
        ...
        try
          ...
          Bmp[1].Canvas.CopyRect(Rect(0, 0, rct.Right - rct.Left,
            rct.Bottom - rct.Top), Bmp[0].Canvas, rct);
          Png.Assign(Bmp[1]);
          ...
          begin
            ...
            // copy knob area
            Bmp[2].Canvas.CopyRect(Rect(0, 0, rct.Right - rct.Left,
              rct.Bottom - rct.Top), Bmp[0].Canvas, rct);
                  ...
                  case StitchType of
                    stHorizontal:
                      begin
                        ...
                        Png.Resize(Png.Width + (rct.Right - rct.Left),
                          Png.Height);
                        Png.Canvas.CopyRect
                          (Rect(Png.Width - (rct.Right - rct.Left), 0,
                          Png.Width, Png.Height), Bmp[2].Canvas,
                          Rect(0, 0, rct.Right - rct.Left,
                          rct.Bottom - rct.Top));
                        Bmp[1].Assign(Bmp[2]);
                      end;
                    stVertical:
                      begin
                        Png.Resize(Png.Width,
                          Png.Height + (rct.Bottom - rct.Top));
                        Png.Canvas.CopyRect
                          (Rect(0, Png.Height - (rct.Bottom - rct.Top),
                          Png.Width, Png.Height), Bmp[2].Canvas,
                          Rect(0, 0, rct.Right - rct.Left,
                          rct.Bottom - rct.Top));
                        Bmp[1].Assign(Bmp[2]);
