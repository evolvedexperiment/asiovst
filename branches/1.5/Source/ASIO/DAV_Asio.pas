...
type
  ...
  TAsioTime = packed record // both input/output
    ...
    TimeCode: TAsioTimeCode;
    // optional, evaluated if (timeCode.flags and kTcValid)
  end;
...
type
  TAsioBufferSwitchProc = procedure(DoubleBufferIndex: LongInt;
    DirectProcess: TAsioBool); cdecl;
  TAsioSampleRateDidChangeProc = procedure(SampleRate: TAsioSampleRate); cdecl;
  TAsioMessageFunc = function(Selector, Value: LongInt; message: Pointer;
    opt: PDouble): LongInt; cdecl;
  TAsioBufferSwitchTimeInfoFunc = function(var Params: TAsioTime;
