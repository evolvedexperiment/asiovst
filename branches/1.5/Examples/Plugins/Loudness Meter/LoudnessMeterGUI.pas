...
begin
  ...
  begin
    ...
    begin
      ...
      LbLoudness.Font.Color := $000080FF
    else if Value < 1 then
      LbLoudness.Font.Color := $0000AE00
    else
    begin
...
begin
  ...
  begin
    ...
    begin
      ...
      LbMomentaryPeak.Font.Color := $000080FF
    else if Value < 1 then
      LbMomentaryPeak.Font.Color := $0000AE00
    else
    begin
...
begin
  with TLoudnessMeterModule(Owner) do
    LbUnit.Caption := string(ParameterDisplay[0]);
...
begin
  with TLoudnessMeterModule(Owner) do
    TrScreenUpdate.Enabled := Parameter[2] > 0.5;
end;
...
begin
  ...
  begin
    ...
    case Round(Parameter[1]) of
      0:
        MiIntegrationMomentary.Checked := True;
      1:
        MiIntegrationShort.Checked := True;
      2:
        MiIntegrationLongTerm.Checked := True;
    end;
  end;
