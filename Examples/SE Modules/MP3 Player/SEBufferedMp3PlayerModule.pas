...
type
  ...
  TSEBufferedMp3PlayerPins = (pinFileName, pinBufferSize, pinSemitones,
...
procedure TSEBufferedMp3PlayerModule.PlugStateChange(const CurrentPin: TSEPin);
begin
  inherited;
...
procedure TSEBufferedMp3PlayerModule.SubProcess(const BufferOffset,
...
procedure TSEBufferedMp3PlayerModule.SubProcessBypass(const BufferOffset,
  SampleFrames: Integer);
begin
...
class procedure TSEBufferedMp3PlayerModule.GetModuleProperties
...
function TSEBufferedMp3PlayerModule.GetPinProperties(const Index: Integer;
