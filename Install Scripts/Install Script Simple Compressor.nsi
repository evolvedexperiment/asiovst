...
Section "Simple Compressor VST-Plugin" SecVstPlugins
  SetOutPath "$INSTDIR"
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\UninstallSimpleCompressor.exe"
SectionEnd
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecVstPlugins ${LANG_ENGLISH} "Simple Compressor VST Plugin"
