...
procedure TCustomSELightweightFiltersModule.PlugStateChange
...
procedure TCustomSELightweightFiltersModule.SubProcess(const BufferOffset,
...
class procedure TCustomSELightweightFiltersModule.GetModuleProperties
...
function TCustomSELightweightFiltersModule.GetPinProperties
...
class procedure TSELightweightLowpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
...
class procedure TSELightweightHighpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSELightweightBandpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSELightweightNotchModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSELightweightLowshelfModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSELightweightHighshelfModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSELightweightPeakModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSELightweightAllpassModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
...
class procedure TSELightweightShapeModule.GetModuleProperties
  (Properties: PSEModuleProperties);
begin
  inherited GetModuleProperties(Properties);
  with Properties^ do
