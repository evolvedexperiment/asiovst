...
type
  ...
  TSEBarberpolePins = (pinInput, pinOutput, pinStages, pinDepth,
    pinSpeed, pinMix);
...
constructor TSEBarberpoleModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
procedure TSEBarberpoleModule.SubProcess(const BufferOffset,
...
begin
  ...
  for Sample := 0 to SampleFrames - 1 do
    Outp^[Sample] := FBarberpole.ProcessSample32(Inp^[Sample]);
end;

procedure TSEBarberpoleModule.SubProcessStatic(const BufferOffset,
  SampleFrames: Integer);
begin
...
class procedure TSEBarberpoleModule.GetModuleProperties
...
function TSEBarberpoleModule.GetPinProperties(const Index: Integer;
...
begin
  ...
  case TSEBarberpolePins(CurrentPin.PinID) of
    ...
    pinStages:
      FBarberpole.Stages := FStages;
    pinDepth:
      FBarberpole.Depth := FDepth;
    pinSpeed:
      FBarberpole.Speed := FSpeed;
    pinMix:
      FBarberpole.Mix := FMix;
  end;
end;
