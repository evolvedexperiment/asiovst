...
type
  ...
  protected
    ...
    procedure SetItem(Index: Integer;
      const Value: TGuiPngImageCollectionItem); virtual;
    procedure Notify(Item: TCollectionItem;
      Action: TCollectionNotification); override;
    property Items[Index: Integer]: TGuiPngImageCollectionItem read GetItem
  ...
  protected
    property Items[Index: Integer]: TGuiPngImageCollectionItem
      read GetItems; default;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  published
    property PngImages: TGuiPngImageCollection read FPngImageCollection
      write FPngImageCollection;
...
function TGuiPngImageCollection.GetItem(Index: Integer)
  : TGuiPngImageCollectionItem;
begin
  Result := TGuiPngImageCollectionItem(inherited GetItem(Index));
end;

function TGuiPngImageCollection.Insert(Index: Integer)
  : TGuiPngImageCollectionItem;
begin
