...
type
  ...
  TBrickwallLimiterAutomatableSEModule = class
  ...
  TBrickwallSoftLimiterStaticSEModule = class
  ...
  TBrickwallSoftLimiterParamStaticSEModule = class
  ...
  TBrickwallSoftLimiterAutomatableSEModule = class
    (TCustomSoftBrickwallLimiterSEModule)
  private
    procedure SubProcessStatic(const BufferOffset, SampleFrames: Integer);
  protected
  ...
  TCustomSimpleSoftBrickwallLimiterSEModule = class
  ...
  TBrickwallSimpleSoftLimiterStaticSEModule = class
  ...
  TBrickwallSimpleSoftLimiterParamStaticSEModule = class
  ...
  TBrickwallSimpleSoftLimiterAutomatableSEModule = class
    (TCustomSimpleSoftBrickwallLimiterSEModule)
  private
    procedure SubProcessStatic(const BufferOffset, SampleFrames: Integer);
  protected
  ...
  TSimpleSoftLimiterAutomatableSEModule = class
  ...
  TSoftKneeCompressorParamStaticSEModule = class
  ...
  TSoftKneeCompressorAutomatableSEModule = class
...
class procedure TCustomDynamicsSEModule.GetModuleProperties
...
procedure TCustomDynamicsSEModule.SubProcessStatic(const BufferOffset,
...
function TCustomDynamicsSEModule.GetPinProperties(const Index: Integer;
...
constructor TSimpleDirectGateStaticSEModule.Create(SEAudioMaster
...
begin
  ...
  case CurrentPin.PinID of
    2:
      FDynamicProcesor.Threshold_dB := FThreshold;
  end;
  inherited;
end;
...
procedure TSimpleDirectGateAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    2:
      if (Pin[2].Status <> stRun) then
        OnProcess := SubProcessStatic
      else
        OnProcess := SubProcess;
  end;
...
procedure TSimpleDirectGateAutomatableSEModule.SubProcessStatic
...
constructor TCustomSoftDirectGateSEModule.Create(AudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited Create(AudioMaster, Reserved);
...
constructor TSoftDirectGateStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
begin
  ...
  case CurrentPin.PinID of
    2:
      FDynamicProcesor.Threshold_dB := FThreshold;
    3:
      FDynamicProcesor.Knee_dB := FKnee_dB;
  end;
  inherited;
end;
...
procedure TSoftDirectGateAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    2:
      if (Pin[2].Status <> stRun) and (Pin[3].Status <> stRun) then
        OnProcess := SubProcessStatic
      else
        OnProcess := SubProcess;
  end;
...
procedure TSoftDirectGateAutomatableSEModule.SubProcessStatic
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TCustomBrickwallLimiterSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    2:
      FDynamicProcesor.AutoMakeUp := FAutoMakeUp;
  end;
  inherited;
end;
...
constructor TBrickwallLimiterStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
procedure TBrickwallLimiterAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    3:
      if (Pin[3].Status <> stRun) then
        OnProcess := SubProcessStatic
      else
        OnProcess := SubProcess;
  end;
...
procedure TBrickwallLimiterAutomatableSEModule.SubProcessStatic
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TBrickwallSoftLimiterStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
function TBrickwallSoftLimiterStaticSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TBrickwallSoftLimiterAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    3 .. 4:
      if (Pin[3].Status <> stRun) and (Pin[4].Status <> stRun) then
        OnProcess := SubProcessStatic
      else
        OnProcess := SubProcess;
  end;
...
procedure TBrickwallSoftLimiterAutomatableSEModule.SubProcess
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
procedure TBrickwallSoftLimiterAutomatableSEModule.SubProcessStatic
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TBrickwallSimpleSoftLimiterStaticSEModule.Create
...
function TBrickwallSimpleSoftLimiterStaticSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TBrickwallSimpleSoftLimiterStaticSEModule.SubProcess
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
class procedure TBrickwallSimpleSoftLimiterParamStaticSEModule.
  GetModuleProperties(Properties: PSEModuleProperties);
begin
  inherited;
  with Properties^ do
  begin
...
class procedure TBrickwallSimpleSoftLimiterAutomatableSEModule.
  GetModuleProperties(Properties: PSEModuleProperties);
begin
  inherited;
  with Properties^ do
...
procedure TBrickwallSimpleSoftLimiterAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
...
procedure TBrickwallSimpleSoftLimiterAutomatableSEModule.SubProcess
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
procedure TBrickwallSimpleSoftLimiterAutomatableSEModule.SubProcessStatic
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TCustomRangeGateSEModule.Create(AudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited Create(AudioMaster, Reserved);
...
constructor TRangeGateStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TRangeGateStaticSEModule.PlugStateChange(const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    2:
      FDynamicProcesor.Threshold_dB := FThreshold;
    3:
      FDynamicProcesor.Range_dB := FRange;
    4:
      FDynamicProcesor.Attack := FAttack;
    5:
      FDynamicProcesor.Release := FRelease;
  end;
  inherited;
end;
...
function TRangeGateAutomatableSEModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TRangeGateAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    2 .. 5:
      if (Pin[2].Status <> stRun) and (Pin[3].Status <> stRun) and
        (Pin[4].Status <> stRun) and (Pin[5].Status <> stRun) then
        OnProcess := SubProcessStatic
      else
        OnProcess := SubProcess;
  end;
...
constructor TCustomClassicGateSEModule.Create(AudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited Create(AudioMaster, Reserved);
...
constructor TClassicGateStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TClassicGateStaticSEModule.PlugStateChange(const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    2:
...
function TClassicGateAutomatableSEModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TClassicGateAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
...
constructor TSoftClassicGateStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
procedure TSoftClassicGateAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    2 .. 5:
      if (Pin[2].Status <> stRun) and (Pin[3].Status <> stRun) and
        ...
        OnProcess := SubProcessAutomated;
  end;
  inherited;
end;

procedure TSoftClassicGateAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TCustomSimpleLimiterSEModule.Create(AudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited Create(AudioMaster, Reserved);
...
constructor TLimiterStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TLimiterStaticSEModule.PlugStateChange(const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    3:
...
function TLimiterAutomatableSEModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
begin
  case CurrentPin.PinID of
    3 .. 5:
      if (Pin[3].Status <> stRun) and (Pin[4].Status <> stRun) and
        (Pin[5].Status <> stRun) then
        OnProcess := SubProcess
      else
        OnProcess := SubProcessAutomated;
  end;
...
constructor TCustomSoftLimiterSEModule.Create(AudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited Create(AudioMaster, Reserved);
...
constructor TSoftLimiterStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TSoftLimiterStaticSEModule.PlugStateChange(const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    3:
...
function TSoftLimiterAutomatableSEModule.GetPinProperties(const Index: Integer;
  Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
procedure TSoftLimiterAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    3 .. 6:
      if (Pin[3].Status <> stRun) and (Pin[4].Status <> stRun) and
        (Pin[5].Status <> stRun) and (Pin[6].Status <> stRun) then
        OnProcess := SubProcess
      else
        OnProcess := SubProcessAutomated;
  end;
...
procedure TSoftLimiterAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TSimpleSoftLimiterStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
procedure TSimpleSoftLimiterAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
...
procedure TSimpleSoftLimiterAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TSimpleCompressorStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
procedure TSimpleCompressorAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  case CurrentPin.PinID of
    3 .. 6:
...
procedure TSimpleCompressorAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TSoftKneeCompressorStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
function TSoftKneeCompressorStaticSEModule.GetPinProperties
  (const Index: Integer; Properties: PSEPinProperties): Boolean;
begin
  Result := inherited GetPinProperties(Index, Properties);
  case Index of
...
begin
  ...
  case CurrentPin.PinID of
    ...
    4:
      FDynamicProcesor.Ratio := FRatio;
    5:
      FDynamicProcesor.Knee_dB := FKnee;
    6:
      FDynamicProcesor.Attack := FAttack;
    7:
      FDynamicProcesor.Release := FRelease;
...
procedure TSoftKneeCompressorAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  case CurrentPin.PinID of
    3 .. 7:
      if (Pin[3].Status > stStop) and (Pin[4].Status > stStop) and
        (Pin[5].Status > stStop) and (Pin[6].Status > stStop) and
        (Pin[7].Status > stStop) then
        OnProcess := SubProcessAutomated
      else
        OnProcess := SubProcess;
  end;
...
procedure TSoftKneeCompressorAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
...
constructor TCustomRMSCompressorSEModule.Create(AudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited Create(AudioMaster, Reserved);
...
constructor TRMSCompressorStaticSEModule.Create(SEAudioMaster
  : TSE2AudioMasterCallback; Reserved: Pointer);
begin
  inherited;
  FThreshold := -10;
...
// e.g when the user changes a module's parameters,
// or when audio stops/starts streaming into a pin
procedure TRMSCompressorStaticSEModule.PlugStateChange(const CurrentPin
  : TSEPin);
begin
  // has user altered dynamics parameter?
  case CurrentPin.PinID of
    ...
    4:
      FDynamicProcesor.Ratio := FRatio;
    5:
      TSimpleRMSCompressor(FDynamicProcesor).RMSTime := FRMSTime;
    6:
      FDynamicProcesor.Attack := FAttack;
    7:
      FDynamicProcesor.Release := FRelease;
...
procedure TRMSCompressorAutomatableSEModule.PlugStateChange
  (const CurrentPin: TSEPin);
begin
  case CurrentPin.PinID of
    3 .. 7:
      if (Pin[3].Status <> stRun) and (Pin[4].Status <> stRun) and
        (Pin[5].Status <> stRun) and (Pin[6].Status <> stRun) and
        (Pin[7].Status <> stRun) then
        OnProcess := SubProcess
      else
        OnProcess := SubProcessAutomated;
  end;
...
procedure TRMSCompressorAutomatableSEModule.SubProcessAutomated
  (const BufferOffset, SampleFrames: Integer);
var
  Input: PDAVSingleFixedArray;
  Output: PDAVSingleFixedArray;
