...
constructor TSEBassEnhancerModule.Create(SEAudioMaster: TSE2audioMasterCallback;
  Reserved: Pointer);
begin
...
procedure TSEBassEnhancerModule.SubProcess(const BufferOffset,
...
procedure TSEBassEnhancerModule.SubProcessStatic(const BufferOffset,
  SampleFrames: Integer);
begin
...
class procedure TSEBassEnhancerModule.GetModuleProperties
...
function TSEBassEnhancerModule.GetPinProperties(const Index: Integer;
