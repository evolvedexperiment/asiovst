...
type
  TLeslieDataModule = class(TVSTModule)
    ...
    procedure ParamSpeedDisplay(Sender: TObject; const Index: Integer; var PreDefined: AnsiString);
...
procedure TLeslieDataModule.ParameterLeslieSpeedChange(Sender: TObject;
...
begin
  ...
  if Assigned(FLeslie) then
    FLeslie.LeslieSpeed := FLeslieSpeed;
...
procedure TLeslieDataModule.ParameterLowWidthChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.LowWidth := Value;
...
procedure TLeslieDataModule.ParameterLowThrobChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.LowThrob := Value;
...
procedure TLeslieDataModule.ParameterHighWidthChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.HighWidth := Value;
...
procedure TLeslieDataModule.ParameterHighDepthChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.HighDepth := Value;
...
procedure TLeslieDataModule.ParameterHighThrobChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.HighThrob := Value;
...
procedure TLeslieDataModule.ParameterXOverChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.Crossover := Value;
...
procedure TLeslieDataModule.ParameterOutputChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.OutputGain := Value;
...
procedure TLeslieDataModule.ParameterSpeedChange(Sender: TObject;
  const Index: Integer; var Value: Single);
begin
  if Assigned(FLeslie) then
    FLeslie.Speed := Value;
...
procedure TLeslieDataModule.ParamSpeedDisplay(Sender: TObject;
...
begin
  for Sample := 0 to SampleFrames - 1 do
    FLeslie.ProcessSample(Inputs[0, Sample] + Inputs[1, Sample],
