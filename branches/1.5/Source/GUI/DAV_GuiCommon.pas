...
{$A1}
  ...
  TRGB24WordArray = packed array [0 .. MaxInt div SizeOf(TRGB24Word) - 1]
    of TRGB24Word;
  PRGB24WordArray = ^TRGB24WordArray;
  TArrayOfRGB24Word = array of TRGB24Word;

  TRGB32WordArray = packed array [0 .. MaxInt div SizeOf(TRGB32Word) - 1]
    of TRGB32Word;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            DestPixel.Blue := (SourcePixels[0, 0].Blue + SourcePixels[0, 1].Blue
              + SourcePixels[1, 0].Blue + SourcePixels[1, 1].Blue) div 4;
            DestPixel.Green := (SourcePixels[0, 0].Green + SourcePixels[0,
              1].Green + SourcePixels[1, 0].Green + SourcePixels[1,
              1].Green) div 4;
            DestPixel.Red := (SourcePixels[0, 0].Red + SourcePixels[0, 1].Red +
              SourcePixels[1, 0].Red + SourcePixels[1, 1].Red) div 4;
...
begin
  ...
  begin
    ...
    begin
      ...
      for x := 0 to (Width div 2) - 1 do
      begin
        Line[0, x].B := (Line[1, 2 * x].B + Line[2, 2 * x].B + Line[1,
          2 * x + 1].B + Line[2, 2 * x + 1].B) div 4;
        Line[0, x].G := (Line[1, 2 * x].G + Line[2, 2 * x].G + Line[1,
          2 * x + 1].G + Line[2, 2 * x + 1].G) div 4;
        Line[0, x].R := (Line[1, 2 * x].R + Line[2, 2 * x].R + Line[1,
          2 * x + 1].R + Line[2, 2 * x + 1].R) div 4;
        Line[0, x].A := (Line[1, 2 * x].A + Line[2, 2 * x].A + Line[1,
          2 * x + 1].A + Line[2, 2 * x + 1].A) div 4;
      end;
    end;
  end;
end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            DestPixel.Blue := (SourcePixels[0, 0].Blue + SourcePixels[0, 1].Blue
              + SourcePixels[0, 2].Blue + SourcePixels[1, 0].Blue + SourcePixels
              [1, 1].Blue + SourcePixels[1, 2].Blue + SourcePixels[2, 0].Blue +
              SourcePixels[2, 1].Blue + SourcePixels[2, 2].Blue) div 9;
            DestPixel.Green := (SourcePixels[0, 0].Green + SourcePixels[0,
              1].Green + SourcePixels[0, 2].Green + SourcePixels[1, 0].Green +
              SourcePixels[1, 1].Green + SourcePixels[1, 2].Green + SourcePixels
              [2, 0].Green + SourcePixels[2, 1].Green + SourcePixels[2,
              2].Green) div 9;
            DestPixel.Red := (SourcePixels[0, 0].Red + SourcePixels[0, 1].Red +
              SourcePixels[0, 2].Red + SourcePixels[1, 0].Red + SourcePixels[1,
              1].Red + SourcePixels[1, 2].Red + SourcePixels[2, 0].Red +
              SourcePixels[2, 1].Red + SourcePixels[2, 2].Red) div 9;
            Colors[x, y] := DestPixel;
          end;
        end;
        SrcIntfImg.CreateBitmaps(ImgHandle, ImgMaskHandle, false);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        x3 := 3 * x;
        Line[0, x].B := (Line[1, x3].B + Line[2, x3].B + Line[3, x3].B + Line[1,
          x3 + 1].B + Line[2, x3 + 1].B + Line[3, x3 + 1].B + Line[1, x3 + 2].B
          + Line[2, x3 + 2].B + Line[3, x3 + 2].B) div 9;
        Line[0, x].G := (Line[1, x3].G + Line[2, x3].G + Line[3, x3].G + Line[1,
          x3 + 1].G + Line[2, x3 + 1].G + Line[3, x3 + 1].G + Line[1, x3 + 2].G
          + Line[2, x3 + 2].G + Line[3, x3 + 2].G) div 9;
        Line[0, x].R := (Line[1, x3].R + Line[2, x3].R + Line[3, x3].R + Line[1,
          x3 + 1].R + Line[2, x3 + 1].R + Line[3, x3 + 1].R + Line[1, x3 + 2].R
          + Line[2, x3 + 2].R + Line[3, x3 + 2].R) div 9;
        Line[0, x].A := (Line[1, x3].A + Line[2, x3].A + Line[3, x3].A + Line[1,
          x3 + 1].A + Line[2, x3 + 1].A + Line[3, x3 + 1].A + Line[1, x3 + 2].A
          + Line[2, x3 + 2].A + Line[3, x3 + 2].A) div 9;
      end;
    end;
  end;
end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            DestPixel.Blue := (SourcePixels[0, 0].Blue + SourcePixels[0, 1].Blue
              + SourcePixels[0, 2].Blue + SourcePixels[0, 3].Blue + SourcePixels
              [1, 0].Blue + SourcePixels[1, 1].Blue + SourcePixels[1, 2].Blue +
              SourcePixels[1, 3].Blue + SourcePixels[2, 0].Blue + SourcePixels
              [2, 1].Blue + SourcePixels[2, 2].Blue + SourcePixels[2, 3].Blue +
              SourcePixels[3, 0].Blue + SourcePixels[3, 1].Blue + SourcePixels
              [3, 2].Blue + SourcePixels[3, 3].Blue) div 16;
            DestPixel.Green := (SourcePixels[0, 0].Green + SourcePixels[0,
              1].Green + SourcePixels[0, 2].Green + SourcePixels[0, 3].Green +
              SourcePixels[1, 0].Green + SourcePixels[1, 1].Green + SourcePixels
              [1, 2].Green + SourcePixels[1, 3].Green + SourcePixels[2, 0].Green
              + SourcePixels[2, 1].Green + SourcePixels[2, 2].Green +
              SourcePixels[2, 3].Green + SourcePixels[3, 0].Green + SourcePixels
              [3, 1].Green + SourcePixels[3, 2].Green + SourcePixels[3,
              3].Green) div 16;
            DestPixel.Red := (SourcePixels[0, 0].Red + SourcePixels[0, 1].Red +
              SourcePixels[0, 2].Red + SourcePixels[0, 3].Red + SourcePixels[1,
              0].Red + SourcePixels[1, 1].Red + SourcePixels[1, 2].Red +
              SourcePixels[1, 3].Red + SourcePixels[2, 0].Red + SourcePixels[2,
              1].Red + SourcePixels[2, 2].Red + SourcePixels[2, 3].Red +
              SourcePixels[3, 0].Red + SourcePixels[3, 1].Red + SourcePixels[3,
              2].Red + SourcePixels[3, 3].Red) div 16;
            Colors[x, y] := DestPixel;
          end;
        end;
        SrcIntfImg.CreateBitmaps(ImgHandle, ImgMaskHandle, false);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        x4 := 4 * x;
        Line[0, x].B := (Line[1, x4].B + Line[1, x4 + 1].B + Line[1, x4 + 2].B +
          Line[1, x4 + 3].B + Line[2, x4].B + Line[2, x4 + 1].B + Line[2,
          x4 + 2].B + Line[2, x4 + 3].B + Line[3, x4].B + Line[3, x4 + 1].B +
          Line[3, x4 + 2].B + Line[3, x4 + 3].B + Line[4, x4].B + Line[4,
          x4 + 1].B + Line[4, x4 + 2].B + Line[4, x4 + 3].B) div 16;
        Line[0, x].G := (Line[1, x4].G + Line[1, x4 + 1].G + Line[1, x4 + 2].G +
          Line[1, x4 + 3].G + Line[2, x4].G + Line[2, x4 + 1].G + Line[2,
          x4 + 2].G + Line[2, x4 + 3].G + Line[3, x4].G + Line[3, x4 + 1].G +
          Line[3, x4 + 2].G + Line[3, x4 + 3].G + Line[4, x4].G + Line[4,
          x4 + 1].G + Line[4, x4 + 2].G + Line[4, x4 + 3].G) div 16;
        Line[0, x].R := (Line[1, x4].R + Line[1, x4 + 1].R + Line[1, x4 + 2].R +
          Line[1, x4 + 3].R + Line[2, x4].R + Line[2, x4 + 1].R + Line[2,
          x4 + 2].R + Line[2, x4 + 3].R + Line[3, x4].R + Line[3, x4 + 1].R +
          Line[3, x4 + 2].R + Line[3, x4 + 3].R + Line[4, x4].R + Line[4,
          x4 + 1].R + Line[4, x4 + 2].R + Line[4, x4 + 3].R) div 16;
        Line[0, x].A := (Line[1, x4].A + Line[1, x4 + 1].A + Line[1, x4 + 2].A +
          Line[1, x4 + 3].A + Line[2, x4].A + Line[2, x4 + 1].A + Line[2,
          x4 + 2].A + Line[2, x4 + 3].A + Line[3, x4].A + Line[3, x4 + 1].A +
          Line[3, x4 + 2].A + Line[3, x4 + 3].A + Line[4, x4].A + Line[4,
          x4 + 1].A + Line[4, x4 + 2].A + Line[4, x4 + 3].A) div 16;
      end;
    end;
  end;
end;
...
{$IFDEF WIN_COLOR_FIX}
  ...
  if i <> 0 then
    Result.ARGB := Result.ARGB or TPixel32(Integer(i) - 1).ARGB;
  i := Color and $0000FF00;
  if i <> 0 then
    Result.ARGB := Result.ARGB or TPixel32(Integer(i) - $00000100).ARGB;
  i := Color and $000000FF;
  if i <> 0 then
    Result.ARGB := Result.ARGB or TPixel32(Integer(i) - 1).ARGB shl 16;
{$ELSE}
{$IFDEF USENATIVECODE}
...
begin
  ...
  Result := (Round(R * 255) or (Round(G * 255) shl 8) or
    (Round(B * 255) shl 16));
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if R * COne255th = Cmax then
        H := (G - B) * COne255th / D
      else if G * COne255th = Cmax then
        H := 2 + (B - R) * COne255th / D
      else
        H := 4 + (R - G) * COne255th / D;
      H := H / 6;
