...
type
  ...
  public
    ...
    function ProcessSample(Input: Single; Carrier: Single): Single;
      virtual; abstract;
  end;
  ...
  TLightweightAnalogAutoRingModulator32 = class
  ...
  TLightweightAnalogAutoRingModulator64 = class
...
begin
  Result := (Input + FCoefficients[0] * Carrier) * FastTanhContinousError3
    (Carrier + FCoefficients[1] * Input) + FCoefficients[2] * Carrier +
    FCoefficients[3] * Input
end;
...
procedure TCustomAutoRingModulator32.ProcessBlock32
...
procedure TCustomAutoRingModulator64.ProcessBlock64
...
begin
  Result := (Input + FCoefficients[0] * FLfo.Sine) *
    Tanh(FLfo.Sine + FCoefficients[1] * Input) + FCoefficients[2] * FLfo.Sine +
    FCoefficients[3] * Input;
  FLfo.CalculateNextSample;
end;
...
function TLightweightAnalogAutoRingModulator32.ProcessSample32
  (Input: Single): Single;
begin
  Result := (Input + FCoefficients[0] * FLfo.Sine) * FastTanhContinousError3
    (FLfo.Sine + FCoefficients[1] * Input) + FCoefficients[2] * FLfo.Sine +
    FCoefficients[3] * Input;
  FLfo.CalculateNextSample;
end;
...
function TLightweightAnalogAutoRingModulator64.ProcessSample64
  (Input: Double): Double;
begin
  Result := (Input + FCoefficients[0] * FLfo.Sine) * FastTanhContinousError3
    (FLfo.Sine + FCoefficients[1] * Input) + FCoefficients[2] * FLfo.Sine +
