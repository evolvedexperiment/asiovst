...
constructor TCustomSEVibratoModule.Create(SEAudioMaster
...
procedure TCustomSEVibratoModule.SubProcessStatic(const BufferOffset,
...
function TCustomSEVibratoModule.GetPinProperties(const Index: Integer;
...
class procedure TSEVibratoStaticModule.GetModuleProperties
...
begin
  ...
  case TSEVibratoPins(CurrentPin.PinID) of
    pinDepth:
      FVibrato.Depth := FDepth;
    pinSpeed:
      FVibrato.Speed := FSpeed;
  end;
end;

procedure TSEVibratoStaticModule.SubProcess(const BufferOffset,
  SampleFrames: Integer);
var
...
begin
  ...
  for Sample := 0 to SampleFrames - 1 do
    Outp^[Sample] := FVibrato.ProcessSample32(Inp^[Sample]);
end;
